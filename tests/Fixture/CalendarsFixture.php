...
class CalendarsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'description' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => '', 'collate' => 'utf8_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'UNIQUE_NAME' => ['type' => 'unique', 'columns' => ['container_id', 'name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'container_id' => 1,
                'created' => '2019-08-07 08:53:38',
                'modified' => '2019-08-07 08:53:38'
            ],
        ];
        parent::init();
    }
