...
<div>
    <flippy vertical
        ...
        <flippy-front class="fixFlippy">
            ...
            <span ng-show="grafana.dashboard_id === null" class="text-info padding-left-20">
            <?php echo __('No element selected'); ?>
        </span>
            <div class="no-padding">
                <iframe-directive url="grafana.iframe_url" ng-if="grafana.dashboard_id"></iframe-directive>
            </div>
        </flippy-front>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <select data-placeholder="<?php echo __('Please choose'); ?>"
                                    ...
                                    ng-options="aGD.id as aGD.name for aGD in availableGrafanaUserdefeinedDashboards"
                                    ng-model="grafana.dashboard_id">
                            </select>
