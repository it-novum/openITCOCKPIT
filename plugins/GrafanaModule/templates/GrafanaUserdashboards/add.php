        ...
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    ...
                    <span class="fw-300"><i><?php echo __('Create new user defined Grafana dashboard'); ?></i></span>
                </h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <form ng-submit="submit();" class="form-horizontal"
                        ...
                        <div class="form-group required" ng-class="{'has-error': errors.GrafanaUserdashboard}">
                            ...
                            <div ng-repeat="error in errors.GrafanaUserdashboard">
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    <button class="btn btn-primary" type="submit">
                                        <?php echo __('Create Grafana dashboard'); ?>
                                    </button>
                                    <a back-button fallback-state='GrafanaUserdashboardsIndex' class="btn btn-default">
                                        <?php echo __('Cancel'); ?>
                                    </a>
                                </div>
                            </div>
