...
//  confirmation.
?>
<div class="map-summary-state-popover col-xs-12 animated slideInRight slightBorder"
     ng-if="summaryState"
                ...
                <div class="txt-color-blueDark font-xs padding-top-10 padding-bottom-10">
                    ...
                    <div class="row">
                        ...
                        <div ng-show="summaryState.Hoststatus.isInMonitoring"
                             class="col-lg-8 text-center txt-color-white text-capitalize bg-{{(summaryState.Hoststatus.isHardstate)?summaryState.Hoststatus.humanState:summaryState.Hoststatus.humanState+'-soft'}}">
                        ...
                        <div ng-hide="summaryState.Hoststatus.isInMonitoring"
                             class="col-lg-8 text-center txt-color-white bg-primary">
                    ...
                    <div class="row">
                        ...
                        <div ng-if="summaryState.Services.length > 0"
                             class="col-lg-8 text-center txt-color-white text-capitalize bg-{{summaryState.Services[0].Servicestatus.humanState}}">
                    ...
                    <div class="row padding-top-5" ng-repeat="service in summaryState.Services">
                        <!-- Servicename -->
                        <div class="col-lg-4 cropText" title="{{service.Service.servicename}}">
                        ...
                        <div ng-show="service.Servicestatus.isInMonitoring"
                             class="col-lg-3 text-center txt-color-white text-capitalize bg-{{(service.Servicestatus.isHardstate)?service.Servicestatus.humanState:service.Servicestatus.humanState+'-soft'}}">
                ...
                <div class="txt-color-blueDark font-xs padding-top-10 padding-bottom-10">
                    ...
                    <div class="row">
                        ...
                        <div ng-show="summaryState.Servicestatus.isInMonitoring"
                             class="col-lg-8 text-center txt-color-white text-capitalize bg-{{(summaryState.Servicestatus.isHardstate)?summaryState.Servicestatus.humanState:summaryState.Servicestatus.humanState+'-soft'}}">
                ...
                <div class="txt-color-blueDark font-xs padding-top-10 padding-bottom-10">
                    ...
                    <div class="row padding-top-10" ng-repeat="host in summaryState.Hosts">
                        ...
                        <div ng-show="host.Hoststatus.isInMonitoring"
                             class="col-lg-4 text-center txt-color-white text-capitalize bg-{{(host.Hoststatus.isHardstate)?host.Hoststatus.humanState:host.Hoststatus.humanState+'-soft'}}">
            ...
            <div class="bg-color-white padding-top-10 padding-left-10 padding-bottom-10">
                ...
                <div class="txt-color-blueDark font-xs padding-top-10 padding-bottom-10">
                    ...
                    <div class="row padding-top-10" ng-repeat="service in summaryState.Services">
                        ...
                        <div ng-hide="service.Servicestatus.isInMonitoring"
                             class="col-lg-2 text-center txt-color-white bg-primary">
                            <i class="fa fa-eye-slash"></i>
                        </div>
                        <div class="col-lg-4 cropText">
                            {{service.Servicestatus.output}}
                ...
                <div class="txt-color-blueDark font-xs padding-top-10 padding-bottom-10">
                    ...
                    <div ng-if="summaryState.NotOkHosts.length > 0 || summaryState.NotOkServices.length">
                        ...
                        <div class="row padding-top-5" ng-repeat="notOkService in summaryState.NotOkServices">
                            ...
                            <div class="col-lg-4 cropText" title="notOkService.Servicestatus.output">
