...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            ...
            <span>>
                <?php echo __('External Command API'); ?>
            </span>
        </h1>
    </div>
</div>
...
<div class="jarviswidget">
    <header>
        ...
        <h2><?php echo __('External Command API'); ?></h2>
    </header>
    <div>
        <div class="widget-body">
            ...
            <?php foreach ($externalCommands as $key => $args) : ?>
                <div class="row padding-top-10" ng-show="'<?= h($key) ?>' === selectedCommand">
                    ...
                    <div class="col-xs-12 col-mg-6 col-lg-9">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="input-group-flex">
                                    <span class="input-group-addon bg-downtime txt-color-white" style="width: 70px;">
                                        GET
                                    </span>
                                    <?php
                                    $dest = 'submit';
                            ...
                            <div class="col-xs-12 padding-top-10">
                                <div class="input-group-flex">
                                    <span class="input-group-addon bg-up txt-color-white" style="width: 70px;">
                                        POST
                                    </span>
                                    <?php
                                    $dest = 'submit';
