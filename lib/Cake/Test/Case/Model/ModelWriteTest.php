 ...
 */
	public function testCacheClearOnSave() {
		...
		touch(OLD_CACHE . 'views' . DS . 'some_dir_overallfavorites_index.php');
		touch(OLD_CACHE . 'views' . DS . 'some_dir_overall_favorites_index.php');
		...
		$this->assertFalse(file_exists(OLD_CACHE . 'views' . DS . 'some_dir_overallfavorites_index.php'));
		$this->assertFalse(file_exists(OLD_CACHE . 'views' . DS . 'some_dir_overall_favorites_index.php'));
