angular.module('openITCOCKPIT').directive('wizardHostConfiguration', function($http, $state){
    return {
        restrict: 'E',
        ...
        controller: function($scope, $http, $state, $stateParams, QueryStringService, NotyService, LocalStorageService){
            /** public vars **/
            $scope.init = true;
