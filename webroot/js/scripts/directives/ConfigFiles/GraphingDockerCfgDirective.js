angular.module('openITCOCKPIT').directive('graphingDockerCfg', function($http, $state, NotyService, RedirectService){
    return {
        restrict: 'E',
        ...
        controller: function($scope){
            ...
            $scope.submit = function(){
                $http.post('/ConfigurationFiles/GraphingDocker.json?angular=true',
                    $scope.post
                ).then(function(result){
