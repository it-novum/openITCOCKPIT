...
class NagiosModuleSchema extends CakeSchema {
	...
	public $nagios_acknowledgements = array(
	...
	public $nagios_commenthistory = array(
	...
	public $nagios_configfiles = array(
	...
	public $nagios_configfilevariables = array(
	...
	public $nagios_conninfo = array(
		'conninfo_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
		'instance_id' => array('type' => 'integer', 'null' => false, 'default' => '0', 'length' => 6, 'unsigned' => false),
		...
		'bytes_processed' => array('type' => 'integer', 'null' => false, 'default' => '0', 'unsigned' => false),
		'lines_processed' => array('type' => 'integer', 'null' => false, 'default' => '0', 'unsigned' => false),
		'entries_processed' => array('type' => 'integer', 'null' => false, 'default' => '0', 'unsigned' => false),
		'indexes' => array(
			'PRIMARY' => array('column' => 'conninfo_id', 'unique' => 1)
		),
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'NDO2DB daemon connection information')
	);

	public $nagios_contact_addresses = array(
	...
	public $nagios_contact_notificationcommands = array(
	...
	public $nagios_contactgroup_members = array(
	...
	public $nagios_contactgroups = array(
	...
	public $nagios_contactnotificationmethods = array(
	...
	public $nagios_contactnotifications = array(
	...
	public $nagios_contactstatus = array(
		...
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'Contact status')
	);

	public $nagios_customvariables = array(
	...
	public $nagios_customvariablestatus = array(
		'customvariablestatus_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
		'instance_id' => array('type' => 'integer', 'null' => false, 'default' => '0', 'length' => 6, 'unsigned' => false),
		'object_id' => array('type' => 'integer', 'null' => false, 'default' => '0', 'unsigned' => false, 'key' => 'index'),
		'status_update_time' => array('type' => 'datetime', 'null' => false, 'default' => '0000-00-00 00:00:00'),
		'has_been_modified' => array('type' => 'integer', 'null' => false, 'default' => '0', 'length' => 6, 'unsigned' => false),
		...
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'Custom variable status information')
	);

	public $nagios_dbversion = array(
	...
	public $nagios_downtimehistory = array(
		...
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'Historical scheduled host and service downtime')
	);

	public $nagios_eventhandlers = array(
	...
	public $nagios_externalcommands = array(
	...
	public $nagios_flappinghistory = array(
		...
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'Current and historical record of host and service flapping')
	);

	public $nagios_host_contactgroups = array(
	...
	public $nagios_host_contacts = array(
	...
	public $nagios_host_parenthosts = array(
	...
	public $nagios_hostchecks = array(
		...
		'return_code' => array('type' => 'integer', 'null' => false, 'default' => '0', 'length' => 6, 'unsigned' => false),
		'output' => array('type' => 'string', 'null' => false, 'collate' => 'utf8_general_ci', 'charset' => 'utf8'),
		'long_output' => array('type' => 'text', 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'charset' => 'utf8'),
	...
	public $nagios_hostdependencies = array(
	...
	public $nagios_hostescalation_contactgroups = array(
	...
	public $nagios_hostescalation_contacts = array(
	...
	public $nagios_hostescalations = array(
	...
	public $nagios_hostgroup_members = array(
	...
	public $nagios_hostgroups = array(
	...
	public $nagios_hoststatus = array(
		...
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'Current host status information')
	);

	public $nagios_instances = array(
	...
	public $nagios_logentries = array(
		'logentry_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
		'instance_id' => array('type' => 'integer', 'null' => false, 'default' => '0', 'unsigned' => false, 'key' => 'index'),
	...
	public $nagios_notifications = array(
	...
	public $nagios_processevents = array(
	...
	public $nagios_programstatus = array(
		...
		'last_command_check' => array('type' => 'datetime', 'null' => true, 'default' => '0000-00-00 00:00:00'),
		...
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'Current program status information')
	);

	public $nagios_runtimevariables = array(
	...
	public $nagios_scheduleddowntime = array(
		...
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'Current scheduled host and service downtime')
	);

	public $nagios_service_contactgroups = array(
	...
	public $nagios_service_contacts = array(
	...
	public $nagios_service_parentservices = array(
	...
	public $nagios_servicechecks = array(
	...
	public $nagios_servicedependencies = array(
	...
	public $nagios_serviceescalation_contactgroups = array(
	...
	public $nagios_serviceescalation_contacts = array(
	...
	public $nagios_serviceescalations = array(
	...
	public $nagios_servicegroup_members = array(
	...
	public $nagios_servicegroups = array(
	...
	public $nagios_servicestatus = array(
		...
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'Current service status information')
	);

	public $nagios_statehistory = array(
		'statehistory_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
		'instance_id' => array('type' => 'integer', 'null' => false, 'default' => '0', 'length' => 6, 'unsigned' => false),
		'state_time' => array('type' => 'datetime', 'null' => false, 'default' => '0000-00-00 00:00:00', 'key' => 'primary'),
		...
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'Historical host and service state changes')
	);

	public $nagios_systemcommands = array(
	...
	public $nagios_timedeventqueue = array(
		'timedeventqueue_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
		'instance_id' => array('type' => 'integer', 'null' => false, 'default' => '0', 'length' => 6, 'unsigned' => false, 'key' => 'index'),
		...
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_swedish_ci', 'engine' => 'InnoDB', 'comment' => 'Current Nagios event queue')
	);

	public $nagios_timedevents = array(
	...
	public $nagios_timeperiod_timeranges = array(
	...
	public $nagios_timeperiods = array(
