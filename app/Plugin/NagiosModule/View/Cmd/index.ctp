		...
		<div class="widget-body">
			<div class="row">
				<div class="col-xs-12 col-md-12 col-lg-12">
					...
					<?php
					echo $this->Form->create('Cmd', array(
					...
					<?php foreach($commands as $commandName => $parameters): ?>
						<div id="<?php echo h($commandName); ?>" style="display:none;" class="api_structure_container">
							...
							<br />
							<strong><?php echo __('Notice');?>:</strong> <?php echo __('You need to replace the value for '); ?><span class="txt-color-orange"><?php echo __('API_KEY');?></span> <?php echo __('manually!'); ?>
						</div>
					<?php endforeach; ?>
				</div>
			</div>
