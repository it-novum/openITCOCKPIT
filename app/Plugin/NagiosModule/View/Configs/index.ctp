...
<div class="alert auto-hide alert-success" style="display:none;"
     id="flashMessage"><?php echo __('config file successfully saved'); ?></div>
<div class="row">
                ...
                <div class="col-sm-12">
                    <div class="alert alert-block alert-danger">
                        ...
                        <h4 class="alert-heading"><i
                                    class="fa-fw fa fa-warning"></i> <?php echo __('This might void your warranty!'); ?>
                        </h4>
                    ...
                    <div class="padding-bottom-10"><?php echo __('Current configuration file:'); ?> <span
                                class="text-primary"><?php echo $currentConfigFile; ?></span></div>
                    ...
                    <div class="well formactions ">
                        <div class="pull-right">
                            <input type="button" id="saveContent" value="<?php echo __('Save'); ?>"
