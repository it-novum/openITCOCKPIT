            ...
            <div class="widget-body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        ...
                        <?php
                        echo $this->Form->input('Host.host_object_id', ['type' => 'hidden', 'value' => $host[0]['Host']['host_object_id']]);
                        echo $this->Form->input('Objects.name1', ['value' => $host[0]['Objects']['name1'], 'label' => __('Hostname')]);
                        echo $this->Form->input('Host.alias', ['value' => $host[0]['Host']['alias'], 'label' => __('Description')]);
                        echo $this->Form->input('Host.address', ['value' => $host[0]['Host']['address'], 'label' => __('Address')]);
                        echo $this->Form->input('Host.notes', ['value' => $host[0]['Host']['notes'], 'label' => __('Notes')]);
                        ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        ...
                        <?php
                        echo $this->Form->input('Host.host_object_id', ['type' => 'hidden', 'value' => $host[0]['Host']['host_object_id']]);
                        echo $this->Form->input('Objects.name1', ['value' => $host[0]['Objects']['name1']]);
                        echo $this->Form->input('Host.alias', ['value' => $host[0]['Host']['alias']]);
                        echo $this->Form->input('Host.address', ['value' => $host[0]['Host']['address']]);
                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col col-xs-10">
                                    <label class="toggle pull-left">
                                        <input type="checkbox" id="HostFlapDetection"
                                               name="data[Host][flap_detection_enabled]" value="true"/>
