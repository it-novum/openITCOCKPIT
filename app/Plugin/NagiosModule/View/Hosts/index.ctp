                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table id="host_list" class="table table-striped table-hover table-bordered smart-form" style="">
                            ...
                            <tr>
                                ...
                                <th class="select_datatable no-sort"><?php echo $this->Utils->getDirection($order, 'HostStatus.current_state');
                                    echo $this->Paginator->sort('HostStatus.current_state', 'Hoststatus'); ?></th>
                                ...
                                <th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Objects.name1');
                                    echo $this->Paginator->sort('Objects.name1', 'Hostname'); ?></th>
                                <th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Host.address');
                                    echo $this->Paginator->sort('address', 'IP-Address'); ?></th>
                                <th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Host.display_name');
                                    echo $this->Paginator->sort('display_name', 'UUID'); ?></th>
                                <th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Host.host_object_id');
                                    echo $this->Paginator->sort('host_object_id', 'host_object_id'); ?></th>
                                <th class="no-sort"><?php echo $this->Utils->getDirection($order, 'HostStatus.output');
                                    echo $this->Paginator->sort('HostStatus.output', 'Output'); ?></th>
                            ...
                            <?php foreach ($all_hosts as $host): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/nagios_module/hosts/browser/<?php echo $host['Host']['host_object_id']; ?>"><?php echo $host['Objects']['name1']; ?></a>
                                    </td>
                                    ...
                                    <td class="text-center"><a
                                                href="/<?php echo $this->params['plugin']; ?>/<?php echo $this->params['controller']; ?>/edit/<?php echo $host['Host']['host_object_id']; ?>"
