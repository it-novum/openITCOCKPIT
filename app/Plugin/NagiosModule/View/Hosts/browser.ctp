    ...
    <div class="col-xs-12 col-sm-5 col-md-6 col-lg-6">
        <h5>
            <span class="pull-right"><a
                        href="/nagios_module/hosts/edit/<?php echo $host[0]['Host']['host_object_id']; ?>"><i
                            class="fa fa-cog "></i> <span
                            class="underline">E</span>dit host</a>&nbsp;&nbsp;&nbsp;</span>
            <span class="pull-right"><i class="fa fa-book "></i> <span
                        class="underline">D</span>oku&nbsp;&nbsp;&nbsp;</span>
                ...
                <div class="widget-body no-padding">
                    ...
                    <div class="tab-content padding-10">
                        <div id="tab1" class="tab-pane fade active in">
                            <?php echo $host[0]['Objects']['name1']; ?> <strong>available
                                since: <?php echo $this->Time->format($host[0]['HostStatus']['last_state_change'], $this->Auth->user('dateformat'), false, $this->Auth->user('timezone')); ?></strong>
                            <br/><br/>
                            <p>The last system check occurred at
                                <strong><?php echo $this->Time->format($host[0]['HostStatus']['status_update_time'], $this->Auth->user('dateformat'), false, $this->Auth->user('timezone')); ?></strong>
                            ...
                            <dl>
                                ...
                                <dd>Maximum attempts per
                                    check: <?php echo $host[0]['Host']['max_check_attempts']; ?></dd>
                                <dt>Check command:</dt>
                                <dd>Command name: <a
                                            href="/nagios_module/commands/edit/<?php echo $command[0]['Command']['object_id']; ?>"><?php echo $command[0]['Objects']['name1']; ?></a>
                                </dd>
                                <dd>Command line: <code
                                            class="<?php echo $this->Nagios->colorHostOutput($host[0]['HostStatus']['current_state']); ?>"><?php echo $command[0]['Command']['command_line']; ?></code>
                                </dd>
                                <dt>Output:</dt>
                                <dd>
                                    <code class="<?php echo $this->Nagios->colorHostOutput($host[0]['HostStatus']['current_state']); ?>"><?php echo $host[0]['HostStatus']['output']; ?></code>
                                </dd>
                            </dl>
                        ...
                        <div id="tab3" class="tab-pane fade">
                            ...
                            <dl>
                                ...
                                <?php echo $this->Nagios->formatNotifyOnHost([
                        ...
                        <div id="tab4" class="tab-pane fade">
                            ...
                            <h5><span class="nag_command" data-toggle="modal"
                                      data-target="#nag_command_schedule_downtime"><i class="fa fa-clock-o"></i> Set planned maintenance times </span><br/>
                            </h5>
                            <h5><span class="nag_command" data-toggle="modal" data-target="#nag_command_flap_detection"><i
                                            class="fa fa-adjust"></i> Enables/disables flap detection for a particular host </span><br/>
                            </h5>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <?php echo $this->Form->input(__('Host check for').':', ['options' => [0 => 'only Host', 1 => 'Host and Services']]); ?>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <?php echo $this->Form->input(__('Comment').':', ['placeholder' => __('testalert')]); ?>
                    <?php echo $this->Form->input(__('Status').':', ['options' => [0 => 'Up', 1 => 'Down', 2 => 'Unreachable']]); ?>
                    <?php echo $this->Form->input(__('Repetitions').':', ['value' => 1]); ?>
                </div>
