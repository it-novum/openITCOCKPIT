                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table id="datatable_fixed_column" class="table table-striped table-hover table-bordered smart-form">
                            ...
                            <tr>
                                ...
                                <th colspan="4"><?php echo getDirection($order, 'ServiceStatus.current_state');
                                    echo $this->Paginator->sort('ServiceStatus.current_state', 'Servicestatus'); ?></th>
                                <th><?php echo getDirection($order, 'Objects.name2');
                                    echo $this->Paginator->sort('Objects.name2', 'Service'); ?></th>
                                <th><?php echo getDirection($order, 'Service.display_name');
                                    echo $this->Paginator->sort('display_name', 'UUID'); ?></th>
                                <th><?php echo getDirection($order, 'Service.service_object_id');
                                    echo $this->Paginator->sort('host_object_id', 'service_object_id'); ?></th>
                                <th><?php echo getDirection($order, 'ServiceStatus.output');
                                    echo $this->Paginator->sort('ServiceStatus.output', 'Output'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
                            ...
                            foreach ($all_services as $service):
                                ...
                                if ($hostNameTmp != $service['Objects']['name1']) {
                                    ...
                                    <tr>
                                        <th>
                                            <center><?php //echo $InterfaceStateHost['html_icon']; 
                                                ?></center>
                                        </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><?php echo $InterfaceStateService['html_icon']; ?></center>
                                    </td>
                                    <td>
                                        <center><i class="fa fa-area-chart fa-lg "></i></center>
                                    </td>
                                    <td>
                                        <center><i class="fa fa-arrow-down  fa-lg"></i></center>
                                    </td>
                                    <td>
