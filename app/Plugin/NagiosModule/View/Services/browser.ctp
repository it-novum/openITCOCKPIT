...
<div class="row">
    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-8 sortable-grid ui-sortable" >
        ...
        -->
            ...
            <li class="">
                <a href="#tab4" data-toggle="tab"> <i class="fa fa-lg fa-gear"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('service.commands'); ?> </span></a>
            </li>
        </ul>
            ...
            <div class="widget-body no-padding">
                ...
                <div class="tab-content padding-10" style="min-height: 304px;">
                    <div id="tab1" class="tab-pane fade active in">
                        ...
                        <?php echo ')'; ?> <strong>available since: <?php echo $this->Time->format($service[0]['ServiceStatus']['last_state_change'], $this->Auth->user('dateformat'), false, $this->Auth->user('timezone')); ?></strong>
                        <br /><br/>
                        <p>The last system check occurred at <strong><?php echo $this->Time->format($service[0]['ServiceStatus']['status_update_time'], $this->Auth->user('dateformat'), false, $this->Auth->user('timezone')); ?></strong> according to Hard check.</p>
                        <dl>
                            <dt>Flap Detection:</dt>
                            <dd><?php echo $this->Nagios->checkFlapDetection($service[0]['ServiceStatus']['flap_detection_enabled'])['html']; ?></dd>
                            <dt>Check options:</dt>
                            <dd>Maximum attempts per check: <?php echo $service[0]['Host']['max_check_attempts']; ?></dd>
                            <dt>Check command:</dt>
                            <dd><code class="<?php echo $this->Nagios->colorServiceOutput($service[0]['ServiceStatus']['current_state']); ?>"><?php echo $service[0]['ServiceStatus']['check_command'];?></code></dd>
							<dd>Command name:</dd>
							<dd>Command line:</dd>
							<dt>Output</dt>
							<dd><code class="<?php echo $this->Nagios->colorServiceOutput($service[0]['ServiceStatus']['current_state']); ?>"><?php echo $service[0]['ServiceStatus']['output'];?></code></dd>
                        </dl>
                    </div>
                    ...
                    <div id="tab3" class="tab-pane fade">
                        ...
                        <dl>
                            ...
                            <?php echo $this->Nagios->formatNotifyOnService(array(
                    ...
                    <div id="tab4" class="tab-pane fade">
                        ...
                        <h5><span class="nag_command" data-toggle="modal" data-target="#nag_command_reschedule"><i class="fa fa-download"></i> Passive transfer of check results</span><br /></h5>
                        <h5><span class="nag_command" data-toggle="modal" data-target="#nag_command_reschedule"><i class="fa fa-clock-o"></i> Set planned maintenance times</span><br /></h5>
                        <h5><span class="nag_command" data-toggle="modal" data-target="#nag_command_reschedule"><i class="fa fa-adjust"></i> Enables/disables flap detection for a particular service</span><br /></h5>
                    </div>
                </div>
    ...
    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable" >
        ...
        <header role="heading">
			...
			<div id="switch-1" class="widget-toolbar" role="menu">
				<span data-original-title="Draw threshold values in graph" data-placement="bottom" rel="tooltip" class="onoffswitch-title"><i class="fa fa-stethoscope"></i></span>
