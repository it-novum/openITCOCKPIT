			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false" >
				...
				<header>
					...
					<ul class="nav nav-tabs pull-left padding-left-20" id="widget-tab-1">
						<li class="active">
							<a href="#tab1" data-toggle="tab"> <i class="fa fa-lg fa-code"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('Commands'); ?></span> </a>
						</li>
						<li class="">
							<a href="#tab2" data-toggle="tab"> <i class="fa fa-lg fa-envelope-o"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('Notifications'); ?> </span></a>
						</li>
						<li class="">
							<a href="#tab3" data-toggle="tab"> <i class="fa fa-lg fa-code-fork"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('Event handler'); ?> </span></a>
						</li>
					</ul>
				</header>
									...
									<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
										<thead>
											<tr>
												...
												<th colspan="3"><?php echo $this->Utils->getDirection($order, 'Objects.name1'); echo $this->Paginator->sort('Objects.name1', 'Commandname'); ?></th>
											</tr>
										</thead>
										<tbody>
											<?php foreach($all_commands['check'] as $command):
												?>
												<tr>
													<td class="text-center"><input class="multiselect" type="checkbox" name="command[<?php echo $command['Command']['object_id']; ?>]" /></td>
													<td><?php echo $command['Objects']['name1']; ?></td>
													<td class="text-center"><a href="/<?php echo $this->params['plugin']; ?>/<?php echo $this->params['controller']; ?>/edit/<?php echo $command['Command']['object_id']; ?>" data-original-title="<?php echo __('edit'); ?>" data-placement="left" rel="tooltip" data-container="body"><i id="list_edit" class="fa fa-gear fa-lg txt-color-teal"></i></a></td>
												</tr>
											<?php endforeach; ?>
										</tbody>
									</table>
								...
								<div id="tab2" class="tab-pane fade">
									<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
										<thead>
											<tr>
												<?php $order = $this->Paginator->param('order'); ?>
												<th colspan="2"><?php echo $this->Utils->getDirection($order, 'Objects.name1'); echo $this->Paginator->sort('Objects.name1', 'Commandname'); ?></th>
											</tr>
										</thead>
										<tbody>
...
<div class="well listTools">
	<div class="row">
		<div class="pointer col-sm-12 col-lg-1 txt-color-blueDark text-center"><span data-original-title="Selected elements" data-placement="top" rel="tooltip" class="selectedElements">(0)</span></div>
		<div class="pointer col-sm-12 col-lg-2 selectAll"><i class="fa fa-lg fa-list-ul"></i> Select all</div>
		<div class="pointer col-sm-12 col-lg-2 undoSelection"><i class="fa fa-lg  fa-rotate-left"></i> Undo selection</div>
		<!-- <div class="pointer col-sm-12 col-lg-2 txt-color-green multiEdit"><i class="fa fa-lg fa-wrench"></i> Edit</div> -->
		<div class="pointer col-sm-12 col-lg-2 "><span class="txt-color-red"><i class="fa fa-lg fa-trash-o"></i> Delete</span></div>
	</div>
</div>