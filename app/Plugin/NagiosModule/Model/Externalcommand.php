...
class Externalcommand extends NagiosModuleAppModel{
	...
	/**
	 * Create an external command to reschedule a host or the host with all Services and select the satellite_id out of the database
	 *
	 * ### Options
	 *
	 * - `uuid`			The UUID of the host you want to reschedule
	 ...
	 * - `forceHardstate`	If the Host should be forced into hard state (for testing notifications) (values: 1, 0, ture or false)
	 * - `repetitions`		the number of repetitions as interger value (normaly the number of max_check_attempts to force hard state)
	 *
	 * @param	array $options with the options
	 * @return	void
	 * @author	Daniel Ziegler <daniel.ziegler@it-novum.com>
	 ...
	 * - `type`		The notification type (0 = default, 1 = broadcast, 2 = forced, 3 = broadcast and forced Weblink: http://old.nagios.org/developerinfo/externalcommands/commandinfo.php?command_id=134)
	 ...
	 * - `downtimetype` The type of the downtime as int (0 => default, 1 => 'Host inc. services, 2 => triggered, 3 => non-triggered)
	 *
	 * @param	array $options with the options
	 * @return	void
	 * @author	Daniel Ziegler <daniel.ziegler@it-novum.com>
	 ...
	 * - `downtimehistory_id`		The downtimehistory_id of table nagios_downtimehistory //May be not needed or coming soon ;)
	 *
	 * @param	int $internal_downtime_id with the options
	 * @param	int $downtimehistory_id of nagios_downtimehistory for force delete //May be not needed or coming soon ;)
	 * @return	void
	 * @author	Daniel Ziegler <daniel.ziegler@it-novum.com>
	 * @since	3.0.1
	 *
