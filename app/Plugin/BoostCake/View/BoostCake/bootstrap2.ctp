...
<div class="row">
    ...
    <div class="span9">
        <h1>BoostCake Examples
            <small>Bootstrap Version 2.3.2</small>
        </h1>
        ...
        <section id="forms">
            ...
            <p>Individual form controls receive styling, but without any required base class on the <code>
                    &lt;form&gt;</code> or large changes in markup. Results in stacked, left-aligned labels on top of
                form controls.</p>
            ...
            <h3>Search form</h3>
            <p>Add <code>.form-search</code> to the form and <code>.search-query</code> to the <code>
                    &lt;input&gt;</code> for an extra-rounded text input.</p>
            ...
            $BoostCake->validationErrors['price_error'] = ['Please provide a price'];
            $BoostCake->validationErrors['password'] = ['Please provide a password'];
            ?>
        ...
        <section id="pagination">
            ...
            $this->Paginator->options(['model' => 'Post']);
            ?>
