...
<div class="row">
    <div class="col col-md-3">
        <ul class="nav nav-pills nav-stacked affix">
            ...
            <li><a href="#pagination"><span class="glyphicon glyphicon-chevron-right pull-right"></span> Pagination</a>
            </li>
    ...
    <div class="col col-md-9">
        <h1>BoostCake Examples
            <small>Bootstrap Version 3.0.0</small>
        </h1>
        ...
        <section id="forms">
            ...
            $BoostCake->validationErrors['price_error'] = ['Please provide a password'];
            ?>
