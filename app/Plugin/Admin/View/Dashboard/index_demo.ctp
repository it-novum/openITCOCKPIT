...
<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-togglebutton="false"
    ...
    <header>
        ...
        <ul id="widget-tab-1" class="nav nav-tabs pull-right">
            <li class="active">
                <a data-toggle="tab" href="#hr1"> <i class="fa fa-lg fa-arrow-circle-o-down"></i> <span
                            class="hidden-mobile hidden-tablet"> Dashboard 1 </span> </a>
            </li>
            <li>
                <a data-toggle="tab" href="#hr2"> <i class="fa fa-lg fa-arrow-circle-o-up"></i> <span
                            class="hidden-mobile hidden-tablet"> Dashboard 2 </span></a>
            </li>
            <li>
                <a data-toggle="tab" href="#hr3"> <i class="fa fa-lg fa-arrow-circle-o-up"></i> <span
                            class="hidden-mobile hidden-tablet"> Dashboard 3 </span></a>
            </li>
            <li>
                <a data-toggle="tab" href="#hr4"> <i class="fa fa-lg fa-arrow-circle-o-up"></i> <span
                            class="hidden-mobile hidden-tablet"> Dashboard 4 </span></a>
            </li>
        </ul>
    </header>
</div>
            ...
            <div class="jarviswidget jarviswidget-sortable" data-widget-deletebutton="false"
                ...
                <header>
                    ...
                    <div class="jarviswidget-ctrls" role="menu">
                        <a class="button-icon jarviswidget-toggle-btn" data-placement="bottom" title="" rel="tooltip"
                           href="#" data-original-title="Collapse">
                            <i class="fa fa-minus "></i>
                        </a>
                        <a class="button-icon jarviswidget-fullscreen-btn" data-placement="bottom" title=""
                           rel="tooltip" href="javascript:void(0);" data-original-title="Fullscreen">
                            <i class="fa fa-expand"></i>
                        </a>
                        <a class="button-icon jarviswidget-delete-btn" data-placement="bottom" title="" rel="tooltip"
                           href="javascript:void(0);" data-original-title="Delete">
    ...
    <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="text-align-center">
                                    <div class="sparkline display-inline" data-sparkline-type='pie'
                                         data-sparkline-piecolor='["#47A447", "#D2322D", "#C4C4C4"]'
        ...
        <article class="col-sm-12 col-md-12 col-lg-6 sortable-grid ui-sortable">
            ...
            <div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false"
                 data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-collapsed="true">
    ...
    <div class="tab-pane fade" id="hr2">
        <div class="row">
            ...
            <article class="col-sm-12 col-md-12 col-lg-12">
                <!-- new widget -->
                <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-calendar"
                     data-widget-colorbutton="false">
