...
<ul>
	<li>
		<div class="clearfix padding-10">
			<input type="text"
				...
				/>
			<a href="/search/index" class="form-control pull-right no-padding" id="searchMainMenu"><i class="fa fa-search-plus"></i></a>
		</div>
	...
	?>
		<li class="<?php echo $isActive($mainData, $current, $hasChildren($mainData)) ? 'active' : '' ?> <?php if($hasChildren($mainData) &&  $isActive($mainData, $current, false)): echo 'open'; else: echo ''; endif; ?>">
			<?php
