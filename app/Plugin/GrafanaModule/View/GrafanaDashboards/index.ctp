...
<div class="jarviswidget">
    ...
    <div>
        <div class="widget-body">
            <?php
            echo $this->Form->create('GrafanaDashboardConfiguration', [
            ...
            <div class="row padding-left-20">
                <div>
                     ...
                     * ??? Exclude Hostgroups
                     * */
                    echo $this->Form->input('GrafanaDashboardConfiguration.api_url', [
                        'label' => __('Grafana API URL'),
                        'placeholder' => __('metrics.example.org/api')
                    ]);
                    echo $this->Form->input('GrafanaDashboardConfiguration.api_key', [
                        'label' => __('Grafana API Key'),
                        'placeholder' => __('ZXhhbXBsZV9ncmFmYW5hX2FwaV9rZXk=')
                    ]);
                    echo $this->Form->input('GrafanaDashboardConfiguration.grapite_prefix', [
                    ...
                    <div class="form-group">
                        <?php
                        echo $this->Form->fancyCheckbox('GrafanaDashboardConfiguration.use_https', [
                            'caption'          => __('Use HTTPS'),
                            'wrapGridClass'    => 'col col-xs-10',
                            'captionGridClass' => 'col col-md-2',
                            'captionClass'     => 'control-label',
                            'checked'          => $this->CustomValidationErrors->refill('Grafana.use_https', 1)
                        ]);
                    ?>
                    </div>
                    <div class="form-group">
                        <?php
                        echo $this->Form->fancyCheckbox('GrafanaDashboardConfiguration.ignore_ssl_certificate', [
                            'caption'          => __('Ignore SSL Certificate'),
                            'wrapGridClass'    => 'col col-xs-10',
                            'captionGridClass' => 'col col-md-2',
                            'captionClass'     => 'control-label',
                            'checked'          => $this->CustomValidationErrors->refill('Grafana.ignore_ssl_certificate', 1)
                        ]);
                        ?>
                    </div>
                    <?php
                        echo $this->Form->input('GrafanaDashboardConfiguration.Hostgroup', [
                            'options' => $hostgroups,
                            'class' => 'chosen',
                            'multiple' => true,
                            'style' => 'width:100%;',
