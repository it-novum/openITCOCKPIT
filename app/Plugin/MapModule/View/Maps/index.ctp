                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table id="contactgroup_list" class="table table-striped table-hover table-bordered smart-form" style="">
                            ...
                            <tr>
                                ...
                                <th class="select_datatable no-sort"><?php echo $this->Utils->getDirection($order, 'Map.name');
                                    echo $this->Paginator->sort('Map.name', 'Map name'); ?></th>
                                <th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Map.title');
                                    echo $this->Paginator->sort('Map.title', 'Map title'); ?></th>
                                    ...
                                    <td class="text-center">
                                        <?php if ($this->Acl->hasPermission('edit') && $allowEdit): ?>
                                            <input class="massChange" type="checkbox"
                                                   name="map[<?php echo $map['Map']['id']; ?>]"
                                                   mapname="<?php echo h($map['Map']['name']); ?>"
                                                   value="<?php echo $map['Map']['id']; ?>"/>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                ...
                                                <li>
                                                    <a href="<?php echo Router::url(['controller' => 'mapeditors', 'action' => 'view', 'plugin' => 'map_module', 'fullscreen' => 1, $map['Map']['id']]); ?>"><i
                                                                class="glyphicon glyphicon-resize-full"></i> <?php echo __('View in fullscreen'); ?>
                                                    </a>
                                                </li>
                                                <?php if ($this->Acl->hasPermission('edit') && $allowEdit): ?>
                                                    <li class="divider"></li>
