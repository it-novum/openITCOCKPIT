...
class  Cpdf
{
    ...
    /**
     * current colour for fill operations, defaults to inactive value, all three components should be between 0 and 1
     * inclusive when active
     */
    ...
    /**
     * messages are stored here during processing, these can be selected afterwards to give some useful debug
     * information
     */
    public $messages = '';
   ...
   */
     ...
     * @var array array of 4 numbers, defining the bottom left and upper right corner of the page. first two are
     *      normally zero.
     * @var boolean whether text will be treated as Unicode or not.
     */
    function Cpdf($pageSize = [0, 0, 612, 792], $isUnicode = false, $fontcache = '', $tmp = '')
    {
...
//      }
     ...
     * if this is called on an existing document results may be unpredictable, but the existing document would be lost
     * at minimum this function is called automatically by the constructor function
     * @access private
     */
        ...
        if (!isset($this->fonts[$fontName])) {
            ...
            if (isset($this->fonts[$fontName])) {
                ...
                if (mb_strlen($fbtype, '8bit')) {
                    ...
                    $tmp = ['BaseFont' => $adobeFontName, 'MissingWidth' => $missing_width, 'Widths' => $widthid, 'FirstChar' => $firstChar, 'LastChar' => $lastChar, 'FontDescriptor' => $fontDescriptorId];
