...
class Frame
{
    ...
    {
        return $this->_style->length_in_pt([$this->_style->height,
    ...
    {
        return $this->_style->length_in_pt([$this->_style->width,
    ...
    function get_padding_box()
    {
        ...
        $w = $this->_style->length_in_pt([$this->_style->padding_left,
            $this->_style->width,
            $this->_style->padding_right],
            $this->_containing_block["w"]);

        $h = $this->_style->length_in_pt([$this->_style->padding_top,
            $this->_style->height,
            $this->_style->padding_bottom],
            $this->_containing_block["w"]);
    ...
    function get_border_box()
    {
        ...
        $w = $this->_style->length_in_pt([$this->_style->border_left_width,
            $this->_style->padding_left,
            $this->_style->width,
            $this->_style->padding_right,
            $this->_style->border_right_width],
        ...
        $h = $this->_style->length_in_pt([$this->_style->border_top_width,
            $this->_style->padding_top,
            $this->_style->height,
            $this->_style->padding_bottom,
            $this->_style->border_bottom_width],
