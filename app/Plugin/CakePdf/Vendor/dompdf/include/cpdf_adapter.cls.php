...
class CPDF_Adapter implements Canvas
{
     ...
     * @var array;
     */
    static $PAPER_SIZES = ["4a0"                      => [0, 0, 4767.87, 6740.79],
                           ...
                           "commerical #10 envelope"  => [0, 0, 684, 297],
    ...
    function filled_rectangle($x1, $y1, $w, $h, $color, $blend = "Normal", $opacity = 1.0)
    {
        ...
        $this->_set_line_style(1, "square", "miter", []);
        $this->_set_line_transparency($blend, $opacity);
    ...
    function text($x, $y, $text, $font, $size, $color = [0, 0, 0],
     ...
     */
    function page_text($x, $y, $text, $font, $size, $color = [0, 0, 0],
                       $adjust = 0, $angle = 0)
    {
        $_t = "text";
