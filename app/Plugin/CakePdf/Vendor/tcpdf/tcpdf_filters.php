...
class TCPDF_FILTERS
{
     ...
     * @private
     */
    private $available_filters = ['ASCIIHexDecode', 'ASCII85Decode', 'LZWDecode', 'FlateDecode', 'RunLengthDecode'];
...
// -----------------------------------------------------------------------------
    ...
    /**
     * LZWDecode
     * Decompresses data encoded using the LZW (Lempel-Ziv-Welch) adaptive compression method, reproducing the original
     * text or binary data.
     *
     * @param $data (string) Data to decode.
     *
    ...
    /**
     * FlateDecode
     * Decompresses data encoded using the zlib/deflate compression method, reproducing the original text or binary
     * data.
     *
     * @param $data (string) Data to decode.
     *
     ...
     * Decompresses data encoded using the JBIG2 standard, reproducing the original monochrome (1 bit per pixel) image
     * data (or an approximation of that data).
     *
     * @param $data (string) Data to decode.
     *
     * @return Decoded data string.
