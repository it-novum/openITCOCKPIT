...
class TCPDF_UNICODE_DATA
{
    ...
    /**
     * Pattern to test Arabic strings using regular expressions. Source:
    ...
    /**
     * Mirror unicode characters. For information on bidi mirroring, see UAX #9: Bidirectional Algorithm, at
     ...
     * Putting the combining mark and character in the same glyph allows us to avoid the two marks overlapping each
     * other in an illegible manner. second NSM char code => substitution char
     * @public
     */
