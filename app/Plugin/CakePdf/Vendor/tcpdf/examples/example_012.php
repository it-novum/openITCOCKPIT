...
$pdf->Ellipse($xc, $yc, $rx = 30, $ry = 15, $angle = 45, $astart = 0, $afinish = 360, $style = 'D', $line_style = [], $fill_color = [], $nc = 2);

// ellipse arc
$pdf->SetDrawColor(255, 0, 0);
$pdf->Ellipse($xc, $yc, $rx = 30, $ry = 15, $angle = 45, $astart = 45, $afinish = 90, $style = 'D', $line_style = [], $fill_color = [], $nc = 2);
