...
class CakePdf
{
     ...
     *
     * @param mixed $html Html content to render. If left empty, the template will be rendered with viewVars and layout
     *                    that have been set.
     *
     * @return string
     */
    ...
    protected function _render()
    {
        ...
        $pluginName = pluginSplit($this->_template);
        if ($pluginName[0] !== null) {
            $View->plugin = $pluginName[0];
        }
