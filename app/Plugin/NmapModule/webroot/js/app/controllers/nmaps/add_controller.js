...
App.Controllers.NmapsAddController = Frontend.AppController.extend({
	...
	_initialize: function(){
		 ...
		 */
		$('#NmapTemplateContainerId').change(function(){
			getServiceTemplates(encodeURIComponent($(this).val()));
		});

		function getServiceTemplates(myVal){
			$.ajax({
				url: "/servicetemplategroups/loadServicetemplatesByContainerId/"+myVal+".json",
				type: "POST",
				error: function(){},
				success: function(){},
				complete: function(response){
					var $selectServicetemplates = $('#NmapTemplateServicetemplateId');
