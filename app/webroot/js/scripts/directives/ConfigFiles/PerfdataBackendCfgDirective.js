angular.module('openITCOCKPIT').directive('perfdataBackendCfg', function($http, $state, NotyService, RedirectService){
    return {
        restrict: 'E',
        ...
        controller: function($scope){
            ...
            $scope.submit = function(){
                $http.post('/ConfigurationFiles/PerfdataBackend.json?angular=true',
                    $scope.post
                ).then(function(result){
