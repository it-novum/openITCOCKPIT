angular.module('openITCOCKPIT').directive('nagiosCfg', function($http, $state, NotyService, RedirectService){
    return {
        restrict: 'E',
        ...
        controller: function($scope){
            ...
            $scope.submit = function(){
                $http.post('/ConfigurationFiles/NagiosCfg.json?angular=true',
                    $scope.post
                ).then(function(result){
