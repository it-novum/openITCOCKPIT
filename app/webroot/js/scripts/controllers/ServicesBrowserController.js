                    ...
                    .controller('ServicesBrowserController', function($scope, $http, QueryStringService, $interval){
                        ...
                        $scope.load = function(){
                            ...
                            $http.get("/services/browser/" + $scope.id + ".json", {
                                ...
                                var graphStart = (parseInt(new Date($scope.timezone.server_time).getTime() / 1000, 10) - (3 * 3600));
                                var graphEnd = parseInt(new Date($scope.timezone.server_time).getTime() / 1000, 10);
                                $scope.dataSources = [];
                        ...
                        var renderGraph = function(performance_data){
                            ...
                            options.xaxis.min = lastGraphStart;
                            options.xaxis.max = graphRenderEnd;
