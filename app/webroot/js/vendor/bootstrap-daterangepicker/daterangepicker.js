        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="btn btn-sm btn-success applyBtn" disabled="disabled">' + this.locale.applyLabel + '</button>&nbsp;' +
                    '<button class="btn btn-sm clearBtn">' + this.locale.clearLabel + '</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
