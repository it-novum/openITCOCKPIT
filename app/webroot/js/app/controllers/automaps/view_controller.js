	...
	loadServiceDetails: function(serviceID){
		...
		$.ajax({
				...
				complete: function(response){
					...
					$('#modalHostname').html(response.responseJSON.service.Host.name);
					$('#modelServicename').html(response.responseJSON.serviceName);
					$('#modalServicestate').html(response.responseJSON.servicestatus.Servicestatus.current_state);
					
					$('#modalStateType').html(response.responseJSON.servicestatus.Servicestatus.state_type);
					$('#modalLastCheck').html(response.responseJSON.servicestatus.Servicestatus.last_check);
					$('#modalStateSince').html(response.responseJSON.servicestatus.Servicestatus.last_state_change);
					
					$('#modalOutput').html(response.responseJSON.servicestatus.Servicestatus.output);
					$('#modalPerfdata').html(response.responseJSON.servicestatus.Servicestatus.perfdata);
					...
					if(parseInt(response.responseJSON.servicestatus.Servicestatus.problem_has_been_acknowledged, 10) == 1){
						$('#modalAck').show();
						$('#modalAckText').html(response.responseJSON.acknowledged);
					}
