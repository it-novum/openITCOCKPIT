...
App.Controllers.TimeperiodsIndexController = Frontend.AppController.extend({
	...
	_initialize: function() {
		...
		for ( var i = 0, len = localStorage.length; i < len; ++i ) {
			...
			if(pageUrl.indexOf('DataTables_timeperiod_list_/timeperiods') !== -1){
	...
	setDataTableFilter: function(storageValue){
		...
		var postTextURL = currentURL.substring(currentURL.indexOf('timeperiods') + 11);
		localStorage.setItem('DataTables_timeperiod_list_/timeperiods'+postTextURL, storageValue);
	}
});
