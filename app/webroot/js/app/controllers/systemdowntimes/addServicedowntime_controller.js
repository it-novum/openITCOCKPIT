...
App.Controllers.SystemdowntimesAddServicedowntimeController = Frontend.AppController.extend({
	$table: null,
	...
	_initialize: function() {
		...
		/*
		 * Bind click event on hostnames inside of selectbox
		 */
		...
		$('#SystemdowntimeObjectId').trigger("chosen:updated");
