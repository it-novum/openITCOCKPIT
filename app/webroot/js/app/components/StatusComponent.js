	...
	hostStatusColor:function(state){
		if(state !== undefined){
			...
			case 0:
				...
				break;
			case 1:
				return { 'human_state' : 'Down',
						 'class' : 'btn-danger',
						 'hexColor' : '#d9534f'
						};
				break;
			case 2:
				return { 'human_state' : 'Unreachable',
						 'class' : 'btn-unknown',
						 'hexColor' : '#4C4F53'
						};
				break;
			default:
				return { 'human_state' : 'Not Found',
						 'class' : 'btn-primary',
						 'hexColor' : '#337ab7'
						};
				break;
	...
	serviceStatusColor:function(state){
		if(state !== undefined){
			...
			case 0:
				...
				break;
			case 1:
				return {'human_state' : 'Warning',
						'class' : 'btn-warning',
						'hexColor' : '#f0ad4e'
						};
				break;
			case 2:
				return {'human_state' : 'Critical',
						'class' : 'btn-danger',
						'hexColor' : '#d9534f'
						};
				break;
			case 3:
				return {'human_state' : 'Unknown',
						'class' : 'btn-unknown',
						'hexColor' : '#4C4F53'
						};
				break;
