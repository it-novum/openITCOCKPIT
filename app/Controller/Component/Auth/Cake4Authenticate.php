...
class Cake4Authenticate extends BaseAuthenticate {
    ...
    public function getUser(CakeRequest $request) {
        $username = $request->data('LoginUser.username');
        $password = $request->data('LoginUser.password');
    ...
    public function _findUser($username, $password = null) {
        ...
        $passwordHashed = \Cake\Utility\Security::hash($password, null, true);
