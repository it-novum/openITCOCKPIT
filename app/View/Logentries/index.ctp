                ...
                <header>
                    ...
                    <div id="switch-1" class="widget-toolbar" role="menu">
                        ...
                        <div class="btn-group">
                            ...
                            <input type="hidden" value="<?php if(isset($LogentiresListsettings['limit'])){ echo $LogentiresListsettings['limit'];} ?>" id="listoptions_hidden_limit" name="data[Listsettings][limit]"/>
                        </div>
                        <div class="btn-group">
                            <button data-toggle="dropdown" class="btn dropdown-toggle btn-xs btn-default">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li style="width: 100%;">
                                    <a href="javascript:void(0)" class="listoptions_checkbox text-left">
                                        <input type="checkbox" name="data[Listsettings][logentry_type][<?php echo $logentry_type; ?>]" value="<?php echo $logentry_type; ?>" <?php echo $htmlChecked; ?>/>&nbsp; <?php echo $logentry_name; ?>
                                    </a>
                                </li>
                                <?php endforeach; ?>
                                <li class="divider"></li>
                        ...
                        <div class="mobile_table">
                            <table id="logentries_list" class="table table-striped table-bordered smart-form" style="">
                                ...
                                <tr>
                                    ...
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'logentry_time'); echo $this->Paginator->sort('logentry_time', __('Date')); ?>
                                    </th>
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'logentry_type'); echo $this->Paginator->sort('logentry_type', __('Type')); ?>
                                    </th>
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'logentry_data'); echo $this->Paginator->sort('logentry_data', __('Logentry')); ?>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr>
                                    <td>
                                        <?php echo $logentry['Logentry']['logentry_time']; ?>
                                    </td>
                                    <td>
                                        <?php
