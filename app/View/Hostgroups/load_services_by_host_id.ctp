                ...
                <div class="col-md-2 btn-success">
                    <div class="padding-5">
                        <label for="<?php echo $host['Host']['uuid'].'[0]'; ?>" class="no-padding pointer">
                            <input type="checkbox" name="<?php echo $host['Host']['uuid'].'[0]'; ?>"
                                   id="<?php echo $host['Host']['uuid'].'[0]'; ?>"
                                   class="no-padding pointer state_filter" state="0" checked="checked"
                                   uuid="<?php echo $host['Host']['uuid'].'_service'; ?>"/>
                            <strong>
                ...
                <div class="col-md-2 btn-warning">
                    <div class="padding-5">
                        <label for="<?php echo $host['Host']['uuid'].'[1]'; ?>" class="no-padding pointer">
                            <input type="checkbox" name="<?php echo $host['Host']['uuid'].'[1]'; ?>"
                                   id="<?php echo $host['Host']['uuid'].'[1]'; ?>"
                                   class="no-padding pointer state_filter" state="1" checked="checked"
                                   uuid="<?php echo $host['Host']['uuid'].'_service'; ?>"/>
                            <strong>
                ...
                <div class="col-md-2 btn-danger">
                    <div class="padding-5">
                        <label for="<?php echo $host['Host']['uuid'].'[2]'; ?>" class="no-padding pointer">
                            <input type="checkbox" name="<?php echo $host['Host']['uuid'].'[2]'; ?>"
                                   id="<?php echo $host['Host']['uuid'].'[2]'; ?>"
                                   class="no-padding pointer state_filter" state="2" checked="checked"
                                   uuid="<?php echo $host['Host']['uuid'].'_service'; ?>"/>
                            <strong>
                ...
                <div class="col-md-2 bg-color-blueLight txt-color-white">
                    <div class="padding-5">
                        <label for="<?php echo $host['Host']['uuid'].'[3]'; ?>" class="no-padding pointer">
                            <input type="checkbox" name="<?php echo $host['Host']['uuid'].'[3]'; ?>"
                                   id="<?php echo $host['Host']['uuid'].'[3]'; ?>"
                                   class="no-padding pointer state_filter" state="3" checked="checked"
                                   uuid="<?php echo $host['Host']['uuid'].'_service'; ?>"/>
                            <strong>
                    ...
                    if ($this->Acl->hasPermission('browser', 'services')): ?>
                        <a class="txt-color-blueDark"
                           href="/services/grapherSwitch/<?php echo $service['Service']['id']; ?>"><i
                                    ...
                                    host-uuid="<?php echo $host['Host']['uuid']; ?>"
                                    service-uuid="<?php echo $service['Service']['uuid']; ?>"></i></a>
                    <?php else: ?>
                        <i class="fa fa-area-chart fa-lg popupGraph" host-uuid="<?php echo $host['Host']['uuid']; ?>"
                           service-uuid="<?php echo $service['Service']['uuid']; ?>"></i>
                    <?php endif;
                endif;
            endif;
            ?>
...
if (empty($services)):
    ...
    <tr class="<?php echo $class; ?>">
        <td colspan="10"
            class="txt-color-red italic text-center"><?php echo __('No services associated with this host!'); ?></td>
    </tr>
    <?php
endif;
