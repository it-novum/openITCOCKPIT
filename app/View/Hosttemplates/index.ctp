							...
							<table id="host_list" class="table table-striped table-bordered smart-form" style="">
								<thead>
									<tr>
										...
										<th class="no-sort text-center editItemWidth" style="width:52px;" ><i class="fa fa-gear fa-lg"></i></th>
									</tr>
								</thead>
								<tbody>
											...
											<td>
												<div class="btn-group">
													<?php if($this->Acl->hasPermission('edit') && $allowEdit): ?>
														<a href="/<?php echo $this->params['controller']; ?>/edit/<?php echo $hosttemplate['Hosttemplate']['id']; ?>" class="btn btn-default">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
													<?php else: ?>
													...
													<ul class="dropdown-menu pull-right">
														<?php if($this->Acl->hasPermission('edit') && $allowEdit): ?>
															<li>
																<a href="/<?php echo $this->params['controller']; ?>/edit/<?php echo $hosttemplate['Hosttemplate']['id']; ?>"><i class="fa fa-cog"></i> <?php echo __('Edit'); ?></a>
															</li>
														<?php endif; ?>
														<?php if($this->Acl->hasPermission('usedBy')): ?>
															<li>
																<a href="/<?php echo $this->params['controller']; ?>/usedBy/<?php echo $hosttemplate['Hosttemplate']['id']; ?>"><i class="fa fa-reply-all fa-flip-horizontal"></i> <?php echo __('Used by'); ?></a>
															</li>
														<?php endif; ?>
