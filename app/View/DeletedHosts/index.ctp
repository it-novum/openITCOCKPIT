							...
							<table id="host_list" class="table table-striped table-bordered smart-form" style="">
								<thead>
									<tr>
										...
										<th><?php echo $this->Utils->getDirection($order, 'DeletedHost.name'); echo $this->Paginator->sort('DeletedHost.name', 'Hostname'); ?></th>
										<th><?php echo $this->Utils->getDirection($order, 'DeletedHost.uuid'); echo $this->Paginator->sort('DeletedHost.uuid', __('UUID')); ?></th>
										<th><?php echo $this->Utils->getDirection($order, 'DeletedHost.created'); echo $this->Paginator->sort('DeletedHost.created', __('Date')); ?></th>
										<th><?php echo $this->Utils->getDirection($order, 'DeletedHost.deleted_perfdata'); echo $this->Paginator->sort('DeletedHost.deleted_perfdata', __('Performance data deleted')); ?></th>
									</tr>
								</thead>
								<tbody>
