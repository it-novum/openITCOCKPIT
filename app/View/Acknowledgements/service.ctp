				...
				<header>
					<div class="widget-toolbar" role="menu">
						...
						<ul class="dropdown-menu arrow-box-up-right pull-right">
							...
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="2"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Author'); ?></a></li>
							...
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="4"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Sticky'); ?></a></li>
						</ul>
					...
					<div id="switch-1" class="widget-toolbar" role="menu">
						...
						<div class="widget-toolbar pull-left" role="menu">
							...
							<div class="btn-group">
								...
								<input type="hidden" value="<?php if(isset($AcknowledgementListsettings['limit'])): echo $AcknowledgementListsettings['limit']; endif; ?>" id="listoptions_hidden_limit" name="data[Listsettings][limit]" />
							</div>
						...
						<table id="acknowledgements_list" class="table table-striped table-bordered smart-form" style="">
							<thead>
								<tr>
									...
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Acknowledged.state'); echo $this->Paginator->sort('Acknowledged.state', __('State')); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Acknowledged.entry_time'); echo $this->Paginator->sort('Acknowledged.entry_time', __('Date')); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Acknowledged.author_name'); echo $this->Paginator->sort('Acknowledged.author_name', __('Author')); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Acknowledged.comment_data'); echo $this->Paginator->sort('Acknowledged.comment_data', __('Comment')); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Acknowledged.is_sticky'); echo $this->Paginator->sort('Acknowledged.is_sticky', __('Sticky')); ?></th>
								</tr>
							</thead>
							<tbody>
								...
								<?php foreach($all_acknowledgements as $acknowledgement): ?>
									<tr>
										<td class="text-center"><?php echo $this->Status->humanServiceStatus($service['Service']['uuid'], 'javascript:void(0)', [$service['Service']['uuid'] => ['Servicestatus' => ['current_state' => $acknowledgement['Acknowledged']['state']]]])['html_icon']; ?></td>
