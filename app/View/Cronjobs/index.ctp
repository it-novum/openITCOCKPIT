										...
										<tr>
											...
											<td class="text-center">
												<?php if($this->Acl->hasPermission('edit')): ?>
													<a href="/<?php echo $this->params['controller']; ?>/edit/<?php echo $cronjob['Cronjob']['id']; ?>" data-original-title="<?php echo __('Edit'); ?>" data-placement="left" rel="tooltip" data-container="body"><i id="list_edit" class="fa fa-gear fa-lg txt-color-teal"></i></a>
												<?php endif; ?>
											</td>
										</tr>
									<?php endforeach; ?>
