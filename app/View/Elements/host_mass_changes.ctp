		...
		<div class="btn-group">
			...
			<ul class="dropdown-menu">
				<?php if($this->Acl->hasPermission('edit_details')):?>
					<li>
						<a href="javascript:void(0);" id="editDetailAll"><i class="fa fa-cog"></i> <?php echo __('Edit details'); ?></a>
					</li>
				<?php endif;?>
				...
				<?php if($this->Acl->hasPermission('add', 'hostgroups')):?>
					<li>
						<a href="javascript:void(0);" id="addToGroupAll"><i class="fa fa-sitemap"></i> <?php echo __('Add to hostgroup'); ?></a>
					</li>
				<?php endif; ?>
				<li>
