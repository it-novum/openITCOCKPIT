...
<div class="jarviswidget">
	<header>
		...
		<ul class="nav nav-tabs pull-right in" id="myTab">
			<li class="active">
				<a data-toggle="tab" href="#section1"><i class="fa fa-calendar"></i> <span class="hidden-mobile hidden-tablet"></span></a>
			</li>

			<li>
				<a data-toggle="tab" href="#section2"><i class="fa fa-pie-chart"></i> <span class="hidden-mobile hidden-tablet"></span></a>
			</li>
		</ul>
	</header>
