...
<?php if($this->Acl->hasPermission('view', 'documentations')):?>
	<span style="position:relative;">
		<a href="/documentations/view/<?php echo $host['Host']['uuid']; ?>" data-original-title="<?php echo __('Documentation'); ?>" data-placement="bottom" rel="tooltip" class="btn btn-default btn-sm"><i class="fa fa-book fa-lg"></i></a>
...
<?php if($this->Acl->hasPermission('hostNotification', 'notifications')):?>
	<a href="/notifications/hostNotification/<?php echo $host['Host']['id']; ?>" data-original-title="<?php echo __('Notifications'); ?>" data-placement="bottom" rel="tooltip" class="btn btn-default btn-sm"><i class="fa fa-envelope  fa-lg"></i></a>
<?php endif;?>
<?php if($this->Acl->hasPermission('index', 'hostchecks')):?>
	<a href="/hostchecks/index/<?php echo $host['Host']['id']; ?>" data-original-title="<?php echo __('Check history'); ?>" data-placement="bottom" rel="tooltip" class="btn btn-default btn-sm"><i class="fa fa-check-square-o fa-lg"></i></a>
<?php endif; ?>
<?php if($this->Acl->hasPermission('host', 'statehistories')):?>
	<a href="/statehistories/host/<?php echo $host['Host']['id']; ?>" data-original-title="<?php echo __('State history'); ?>" data-placement="bottom" rel="tooltip" class="btn btn-default btn-sm"><i class="fa fa-history fa-lg"></i></a>
<?php endif;?>
	...
	<ul class="dropdown-menu dropdown-menu-right">
		...
		<?php if($this->params['controller'] == 'hosts' && $this->params['action'] == 'browser'): ?>
			...
			<?php if($this->Acl->hasPermission('ping')):?>
				<li>
					<a href="javascript:void(0);" data-toggle="modal" data-target="#pingmodal" id="pingopen"><i class="fa fa-wifi"></i> <?php echo __('Ping'); ?></a>
				</li>
			<?php endif;?>
		<?php endif;?>
		<?php
