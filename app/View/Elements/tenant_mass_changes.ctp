...
<div class="row">
	...
	<input type="hidden" id="delete_message_h2" value="<?php echo __('Do you really want delete the selected tenants? All nodes, hostgroups, hosts, and services from these selected tenants will be deleted too.'); ?>" />
