...
<div class="widget-body tacho-body" style="padding:0;">
    <div style="display:none;" class="tachoPreviewContainer">
        <div class="pull-right padding-right-20"><a href="javascript:void(0);" class="btn btn-danger close-preview"
                                                    data-widget-id="<?php echo $widget['Widget']['id']; ?>"><?php echo __('Close'); ?></a>
        </div>
    ...
    <div class="panel-group smart-accordion-default" id="accordion-<?php echo $widget['Widget']['id']; ?>">
        <div class="panel panel-default">
            ...
            <div id="collapseOne-1-<?php echo $widget['Widget']['id']; ?>"
                 class="panel-collapse collapse <?php echo ($serviceId === null) ? 'in' : ''; ?>" aria-expanded="true">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <select class="chosen tachoSelectService"
                                        ...
                                        name="data[dashboard][serviceId]" style="width:100%;">
                                    <option></option>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <?php if ($serviceId === null): ?>
                        <a data-toggle="collapse" data-parent="#accordion-<?php echo $widget['Widget']['id']; ?>"
                           href="#collapseTwo-1-<?php echo $widget['Widget']['id']; ?>" aria-expanded="false"
                           class="collapsed">
                            <i class="fa fa-lg fa-angle-down pull-right"></i> <i
                                    class="fa fa-lg fa-angle-up pull-right"></i> <?php echo __('No services selected'); ?>
                        </a>
                    <?php else: ?>
                        <a data-toggle="collapse" data-parent="#accordion-<?php echo $widget['Widget']['id']; ?>"
                           href="#collapseTwo-1-<?php echo $widget['Widget']['id']; ?>" aria-expanded="true" class="">
                            <i class="fa fa-lg fa-angle-down pull-right"></i> <i
                                    class="fa fa-lg fa-angle-up pull-right"></i> <?php echo h($selectedServiceName); ?>
                        </a>
                    <?php endif; ?>
                </h4>
            </div>
            <div id="collapseTwo-1-<?php echo $widget['Widget']['id']; ?>"
                 class="panel-collapse collapse <?php echo ($serviceId === null) ? '' : 'in'; ?>" aria-expanded="false">
                        ...
                        <center>
                            <?php if ($serviceId && $this->Acl->hasPermission('browser', 'services')): ?>
                                <a href="/services/browser/<?php echo $serviceId; ?>">
                                    <canvas id="canvas-<?php echo $widget['Widget']['id']; ?>"
                                            data-check-interval="<?php echo $widgetData['Service']['Servicestatus']['normal_check_interval']; ?>"></canvas>
                                </a>
                            <?php else: ?>
                                <canvas id="canvas-<?php echo $widget['Widget']['id']; ?>"
                                        data-check-interval="<?php echo $widgetData['Service']['Servicestatus']['normal_check_interval']; ?>"></canvas>
