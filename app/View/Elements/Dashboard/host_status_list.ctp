...
<div class="padding-10">
    <div style="border:1px solid #c3c3c3;" class="padding-10">
        <div class="row">
            <div class="col-xs-2">
                <a href="javascript:void(0);" data-widget-id="<?php echo h($widget['Widget']['id']); ?>"
                   class="btn btn-default btn-xs stopRotation btn-primary"><i class="fa fa-pause"></i></a>
                <a href="javascript:void(0);" data-widget-id="<?php echo h($widget['Widget']['id']); ?>"
                   class="btn btn-default btn-xs startRotation" style="display:none;"><i class="fa fa-play"></i></a>
                <?php
                $class = '';
                ...
                ?>
                <a href="javascript:void(0);" class="btn btn-default btn-xs <?php echo $class; ?> listAnimateRight"
                   data-widget-id="<?php echo h($widget['Widget']['id']); ?>"><i class="fa fa-arrow-left"></i></a>
                <?php
                $class = '';
                ...
                ?>
                <a href="javascript:void(0);" class="btn btn-default btn-xs <?php echo $class; ?> listAnimateUp"
                   data-widget-id="<?php echo h($widget['Widget']['id']); ?>"><i class="fa fa-arrow-up"></i></a>
            </div>
            <div class="col-xs-4">
                ...
                <div class="slider-slim width-120 pull-left" data-widget-id="<?php echo h($widget['Widget']['id']); ?>">
                    <input class="slider slider-primary slider-slim statusListUpdateSlider" data-slider-min="3"
                           data-slider-max="30"
                           data-slider-value="<?php echo h($widgetData['Widget']['WidgetHostStatusList']['animation_interval']); ?>"/>
                </div>
            ...
            <div class="col-xs-6 text-right">
                ...
                <a href="javascript:void(0);" class="btn btn-primary btn-xs margin-left-10 saveListSettings"
                   data-widget-id="<?php echo h($widget['Widget']['id']); ?>"><?php echo __('Save'); ?></a>
            </div>
        </div>
    </div>
</div>
<div class="no-padding font-xs tableContainer">
    <?php echo $this->element('Dashboard'.DS.'host_status_list_table', ['widget' => $widget]); ?>
</div>
