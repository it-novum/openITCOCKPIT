			...
			<div class="panel-heading">
				<h4 class="panel-title">
					<a data-toggle="collapse" data-parent="#accordion-<?php echo $widget['Widget']['id'];?>" href="#collapseOne-1-<?php echo $widget['Widget']['id'];?>" aria-expanded="false" class="collapsed">
						<i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right"></i> <?php echo __('Edit Notice'); ?>
					</a>
				</h4>
			</div>
			<div id="collapseOne-1-<?php echo $widget['Widget']['id'];?>" class="panel-collapse collapse <?php echo ($note === null)?'in':''; ?>" aria-expanded="true">
			...
			<div class="panel-heading">
				<h4 class="panel-title">
					<a data-toggle="collapse" data-parent="#accordion-<?php echo $widget['Widget']['id'];?>" href="#collapseTwo-1-<?php echo $widget['Widget']['id'];?>" aria-expanded="true" class="">
						<i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right"></i> <?php echo h('Notice'); ?>
					</a>
				</h4>
			</div>
			<div id="collapseTwo-1-<?php echo $widget['Widget']['id'];?>" class="panel-collapse collapse <?php echo ($note === null)?'':'in'; ?>" aria-expanded="true">
