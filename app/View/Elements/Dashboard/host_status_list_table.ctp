...
?>
<table class="table table-bordered statusListTable" animation="animated <?php echo h($widgetData['Widget']['WidgetHostStatusList']['animation']); ?>" data-widget-id="<?php echo h($widget['Widget']['id']); ?>">
	<thead>
		<tr>
