...
<div class="row">
	...
	<?php endif; ?>
	<div class="col-xs-12 col-md-2"><a href="<?php echo Router::url(['controller' => 'servicegroups', 'action' => 'listToPdf/.pdf']); ?>" style="text-decoration: none; color:#333;" id="listAsPDF"><i class="fa fa-file-pdf-o"></i> <?php echo __('List as PDF') ?></a></div>
	
	<!-- hidden fields for multi language -->
	<input type="hidden" id="delete_message_h1" value="<?php echo __('Attention!'); ?>" />
	<input type="hidden" id="delete_message_h2" value="<?php echo __('Do you really want delete the selected servicegroups?'); ?>" />
