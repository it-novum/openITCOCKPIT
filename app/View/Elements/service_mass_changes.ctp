...
<div class="row">
	...
	<div class="col-xs-12 col-md-2"><a href="javascript:void(0);" id="copyAll" style="text-decoration: none; color:#333;"><i class="fa fa-lg fa-files-o"></i> <?php echo __('Copy to host');?></a></div>
	<div class="col-xs-12 col-md-2"><a href="javascript:void(0);" id="deleteAll" class="txt-color-red" style="text-decoration: none;"> <i class="fa fa-lg fa-trash-o"></i> <?php echo __('Delete'); ?></a></div>
	<div class="col-xs-12 col-md-2">
		<div class="btn-group">
			...
			<ul class="dropdown-menu">
				<li>
					<a href="javascript:void(0);" id="disableAll"><i class="fa fa-plug"></i> <?php echo __('Disable'); ?></a>
				</li>
				<li>
					<a href="javascript:void(0);" id="addToGroupAll"><i class="fa fa-cogs"></i> <?php echo __('Add to servicegroup'); ?></a>
				</li>
				<?php if($this->params['controller'] == 'services' && $this->params['action'] == 'serviceList'): ?>
					...
					<li>
						<a href="javascript:void(0);" data-toggle="modal" data-target="#nag_command_ack_state"><i class="fa fa-user"></i> <?php echo __('Acknowledge status'); ?></a>
					</li>
					<li>
	...
	<input type="hidden" id="disable_message_h2" value="<?php echo __('Do you really want disable the selected services?'); ?>" />
