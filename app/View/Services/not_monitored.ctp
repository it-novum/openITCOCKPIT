                                    ...
                                    if ($tmp_host_name != $service['Host']['name']):
                                        ...
                                        <tr>
                                            <td class="bg-color-lightGray" colspan="12">
                                                ...
                                                echo $this->Status->humanHostStatus($service['Host']['uuid'], $hostHref)['html_icon']; ?>
                                        ...
                                        <td class="width-50">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <?php if ($this->Acl->hasPermission('edit') && $allowEdit): ?>
                                                        <li>
                                                            <a href="<?php echo Router::url(['controller' => $this->params['controller'], 'action' => 'edit', '_controller' => $this->params['controller'], '_action' => $this->params['action'], $service['Service']['id']]); ?>"><i
