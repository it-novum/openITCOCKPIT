	...
	?>
		<div class="jarviswidget" id="wid-id-0">
			<header>
				...
				<h2><?php echo $graph['label']; ?> <span class="text-muted padding-left-10 graphTime"><?php echo date('d.m.Y H:i', $graph['start']);?> - <?php echo date('d.m.Y H:i', $graph['end']);?></span></h2>
				<div class="widget-toolbar" role="menu" style="display:none">
					<a href="javascript:void(0);" class="btn btn-danger btn-xs resetZoom" start="<?php echo h($graph['start']); ?>" end="<?php echo h($graph['end']); ?>" ds="<?php echo h($key); ?>" service_id="<?php echo h($service['Service']['id']); ?>" commandUuid="<?php echo h($commandUuid); ?>"><i class="fa fa-search-minus"></i> <?php echo __('Reset zoom'); ?></a>
				</div>
			</header>
			<div>
				<div class="widget-body">
					<div class="pull-left">
						...
						<div class="grapherLoader text-center" style="display:none;"><i class="fa fa-spin fa-cog fa-5x"></i></div>
					</div>
