			...
			<?php
				...
				<div class="row">
					<div class="col-xs-12 col-md-9 col-lg-7">
						...
						<i class="fa fa-files-o"></i> <strong><?php echo __('The following services will copied'); ?>:</strong>
						<ul>
						...
						<?php if(!empty($servicesCantCopy)): ?>
							<strong class="text-info"><i class="fa fa-info-circle"></i> <?php echo __('The following Service cannot be copied'); ?></strong> <i class="text-info"><?php echo __('(Dynamic service discovery)'); ?>:</i>
							<ul>
