						...
						*/
						...
						<div class="widget-toolbar" role="menu">
							...
							<ul class="dropdown-menu arrow-box-up-right color-select pull-right">
								...
								<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" class="select_datatable text-left" my-column="4"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Hostname'); ?></a></li>
								<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" class="select_datatable text-left" my-column="5"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('IP-Address'); ?></a></li>
								<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" class="select_datatable text-left" my-column="6"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('UUID'); ?></a></li>
								<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" class="select_datatable text-left" my-column="7"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('host_object_id'); ?></a></li>
								<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" class="select_datatable text-left" my-column="8"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Output'); ?></a></li>
							</ul>
						...
						<table id="service_list" class="table table-striped table-bordered smart-form" style="">
							<thead>
								<tr>
									...
									<th class="select_datatable no-sort"><?php echo $this->Utils->getDirection($order, 'ServiceStatus.current_state'); echo $this->Paginator->sort('ServiceStatus.current_state', 'Servicestatus'); ?></th>
									...
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'name'); echo $this->Paginator->sort('name', 'Servicename'); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Service.address'); echo $this->Paginator->sort('address', 'IP-Address'); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Service.display_name'); echo $this->Paginator->sort('display_name', 'UUID'); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Service.service_object_id'); echo $this->Paginator->sort('service_object_id', 'service_object_id'); ?></th>
							...
							<tbody>
								<?php foreach($services as $service): ?>
									...
									<tr>
										...
										<td><a href="/services/browser/<?php echo $service['Service']['id']; ?>"><?php echo $service['Service']['name']; ?></a></td>
										...
										<td class="text-center"><a href="/<?php echo $this->params['controller']; ?>/edit/<?php echo $service['Service']['id']; ?>" data-original-title="<?php echo __('edit'); ?>" data-placement="left" rel="tooltip" data-container="body"><i id="list_edit" class="fa fa-gear fa-lg txt-color-teal"></i></a></td>
									</tr>
								<?php endforeach; ?>
							</tbody>
						</table>
