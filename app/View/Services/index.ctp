			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false" >
				<header>
					...
					<ul class="nav nav-tabs pull-right" id="widget-tab-1">
						<li class="active">
							<a href="/services/index"> <i class="fa fa-stethoscope"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('Monitored'); ?></span> </a>
						</li>
						<?php if($this->Acl->hasPermission('notMonitored')): ?>
							<li class="">
								<a href="/services/notMonitored">
											...
											<tr>
												<td class="bg-color-lightGray" colspan="13">
													...
													<?php if($this->Acl->hasPermission('browser', 'hosts')): ?>
															<a class="padding-left-5 txt-color-blueDark" href="<?php echo $href; ?>"><?php echo h($service['Host']['name']); ?> (<?php echo h($service['Host']['address']); ?>)</a>
													<?php else: ?>
														<?php echo h($service['Host']['name']);?>
													<?php endif;?>
													<?php if($this->Acl->hasPermission('serviceList', 'services')): ?>
														<a class="pull-right txt-color-blueDark" href="/services/serviceList/<?php echo $service['Host']['id']; ?>"><i class="fa fa-list" title="<?php echo __('Go to Service list'); ?>"></i>
													<?php endif; ?>
												</td>
											</tr>
											...
											<tr>
												...
												<td class="text-center">
													<?php if($this->Monitoring->checkForServiceGraph($service['Host']['uuid'], $service['Service']['uuid'])): ?>
														...
														?>
														<a class="txt-color-blueDark" href="<?php echo $graphHref; ?>"><i class="fa fa-area-chart fa-lg popupGraph" host-uuid="<?php echo $service['Host']['uuid']; ?>" service-uuid="<?php echo $service['Service']['uuid']; ?>"></i></a>
													<?php endif;?>
												</td>
												<td class="text-center">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-md-2">
								<div class="btn-group">
									...
									<ul class="dropdown-menu">
										<li>
											<a href="<?php echo Router::url(['controller' => 'services', 'action' => 'listToPdf/.pdf']); ?>" id="listAsPDF"><i class="fa fa-file-pdf-o"></i> <?php echo __('List as PDF') ?></a>
										</li>
