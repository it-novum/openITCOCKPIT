						...
						<div class="btn-group pull-left" style="padding-top: 2px;">
							...
							<ul class="dropdown-menu">
								<?php if($this->Acl->hasPermission('browser', 'hosts')): ?>
									<li>
										<a href="/hosts/browser/<?php echo $host['Host']['id']; ?>"><i class="fa fa-desktop"></i> <?php echo __('Browser'); ?></a>
									</li>
								<?php endif; ?>
								<?php if($this->Acl->hasPermission('edit', 'hosts') && $allowEdit): ?>
									<li>
								...
								<?php if($this->Acl->hasPermission('deactivate', 'hosts') && $allowEdit): ?>
									<li>
										<a href="/hosts/deactivate/<?php echo $host['Host']['id']; ?>"><i class="fa fa-plug"></i> <?php echo __('Disable'); ?></a>
									</li>
								<?php endif;?>
				...
				<header>
					<div class="widget-toolbar" role="menu">
						...
						if($this->Acl->hasPermission('browser', 'hosts')):
							echo $this->Html->link(__('Open host in browser'), '/hosts/browser/'.$host_id, array('class' => 'btn btn-xs btn-primary hidden-mobile', 'icon' => 'fa fa-desktop'));
						endif;
						?>
					</div>
					...
					<ul class="nav nav-tabs pull-right" id="widget-tab-1">
						<li class="active">
							<a href="#tab1" data-toggle="tab"> <i class="fa fa-stethoscope"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('Active'); ?> </span> </a>
						</li>
						<li class="">
							<a href="#tab2" data-toggle="tab"><i class="fa fa-plug"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('Disabled'); ?> </span></a>
						</li>
						<li class="">
							<a href="#tab3" data-toggle="tab"> <i class="fa fa-trash-o"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('Deleted'); ?> </span></a>
						</li>
					</ul>
				</header>
				<div>
											...
											<?php foreach($all_services as $service): ?>
												...
												<tr>
													<td class="text-center width-5">
														<?php if($allowEdit): ?>
															<input type="checkbox" class="massChange" servicename="<?php echo h($serviceName); ?>" value="<?php echo $service['Service']['id']; ?>" uuid="<?php echo $service['Service']['uuid']; ?>">
														<?php endif;?>
													</td>
													...
													<td data-original-title="<?php echo h($this->Time->format($service['Servicestatus']['last_hard_state_change'], $this->Auth->user('dateformat'), false, $this->Auth->user('timezone'))); ?>" data-placement="bottom" rel="tooltip" data-container="body">
											...
											<?php foreach($disabledServices as $disabledService): ?>
												<tr>
													...
													<td>
														<div class="btn-group">
															<?php if($this->Acl->hasPermission('edit', 'services') && $allowEdit): ?>
																<a href="/<?php echo $this->params['controller']; ?>/edit/<?php echo $disabledService['Service']['id']; ?>" class="btn btn-default">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
															<?php else: ?>
																<a href="javascript:void(0);" class="btn btn-default btn-xs">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
															<?php endif; ?>
															<a href="javascript:void(0);" data-toggle="dropdown" class="btn btn-default dropdown-toggle"><span class="caret"></span></a>
															<ul class="dropdown-menu">
																<?php if($this->Acl->hasPermission('edit', 'services') && $allowEdit): ?>
																	<li>
																		<a href="/<?php echo $this->params['controller']; ?>/edit/<?php echo $disabledService['Service']['id']; ?>"><i class="fa fa-cog"></i> <?php echo __('Edit'); ?></a>
																	</li>
																<?php endif; ?>
																<?php if($this->Acl->hasPermission('enable', 'services') && $allowEdit): ?>
																	<li>
																		<a href="/services/enable/<?php echo $disabledService['Service']['id']; ?>"><i class="fa fa-plug"></i> <?php echo __('Enable'); ?></a>
																	</li>
																<?php endif;?>
																<?php if($this->Acl->hasPermission('delete', 'services') && $allowEdit): ?>
																	<li class="divider"></li>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					<?php
					echo $this->Form->create('CommitServiceAck', array(
						'class' => 'form-horizontal clear',
					)); ?>
					<?php echo $this->Form->input('comment', ['value' => __('In progress'), 'label' => __('Comment').':']); ?>
