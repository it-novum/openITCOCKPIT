		...
		<div class="jarviswidget" id="wid-id-0">
			<header>
				...
				<div class="widget-toolbar" role="menu" style="display:none">
					<a href="javascript:void(0);" class="btn btn-danger btn-xs resetZoom" start="<?php echo h($graph['start']); ?>" end="<?php echo h($graph['end']); ?>" ds="<?php echo h($rrd_structure_datasource['ds']); ?>" service_id="<?php echo h($service['Service']['id']); ?>"><i class="fa fa-search-minus"></i> <?php echo __('Reset zoom'); ?></a>
				</div>
			</header>
			<div>
