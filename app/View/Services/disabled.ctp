									...
									<?php foreach($all_services as $service):
										...
										?>
											<tr>
												...
												?>
												<td class="bg-color-lightGray" colspan="12"><?php echo $this->Status->humanHostStatus($service['Host']['uuid'], $hostHref, [$service['Host']['uuid'] => ['Hoststatus' => ['current_state' => $service['Hoststatus']['current_state']]]])['html_icon']; ?><a class="padding-left-5 txt-color-blueDark" href="<?php echo $hostHref; ?>"><?php echo h($service['Host']['name']); ?> (<?php echo h($service['Host']['address']); ?>)</a>
