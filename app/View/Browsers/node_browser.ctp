				...
				<div class="widget-body widget-hide-overflow">
						<?php foreach($browser as $b): ?>
							<?php if(isset($b['Host'])): ?>
								...
								<?php echo $this->Html->link($b['Host']['name'], ['controller' => 'hosts', 'action' => 'browser/'.$b['Host']['id']]); ?>

							<?php elseif(isset($b['Service'])): ?>
								<i class="fa fa-cog"></i>
								<?php echo $this->Html->link($b['Service']['name'], ['controller' => 'services', 'action' => 'browser/'.$b['Service']['id']]); ?>
