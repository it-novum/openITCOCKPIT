			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false" >
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<table id="hoststatehistory_list" class="table table-striped table-bordered smart-form" style="">
							<thead>
								<tr>
									...
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Statehistory.output'); echo $this->Paginator->sort('Statehistory.output', __('Host output')); ?></th>
								</tr>
							</thead>
							<tbody>
