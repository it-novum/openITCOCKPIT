...
<div class="jarviswidget" id="wid-id-0">
	<header>
		...
		<ul class="nav nav-tabs pull-right" id="widget-tab-1">
			<li class="active">
				<a href="#tab1" data-toggle="tab"> <i class="fa fa-lg fa-desktop"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('Host downtime'); ?></span> </a>
			</li>
			<li class="">
				<a href="#tab2" data-toggle="tab"> <i class="fa fa-lg fa-sitemap"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('Hostgroup downtime'); ?> </span></a>
			</li>
			<li class="">
				<a href="#tab3" data-toggle="tab"> <i class="fa fa-lg fa-cog"></i> <span class="hidden-mobile hidden-tablet"> <?php echo __('Service downtime'); ?> </span></a>
			</li>
		</ul>
	</header>
	<div>
				...
				<div class="row">
					<div class="col-xs-12 col-md-9 col-lg-7">
						<div class="tab-content">
							<div id="tab1" class="tab-pane fade active in">
								...
								<div class="form-group">
									<label class="col col-md-2 control-label" for="HostdowntimeFromDate"><?php echo __('From');?>:</label>
									<div class="col col-xs-5" style="padding-right: 0px;">
										<input type="text" id="HostdowntimeFromDate" value="<?php echo date('d.m.Y'); ?>" class="form-control" name="data[Hostdowntime][from_date]">
									</div>
									<div class="col col-xs-5" style="padding-left: 0px;">
										<input type="text" id="HostdowntimeFromTime" value="<?php echo date('h:m'); ?>" class="form-control" name="data[Hostdowntime][from_time]">
									</div>
								</div>

								<!-- to -->
								<div class="form-group">
									<label class="col col-md-2 control-label" for="HostdowntimeToDate"><?php echo __('To');?>:</label>
									<div class="col col-xs-5" style="padding-right: 0px;">
										<input type="text" id="HostdowntimeToDate" value="<?php echo date('d.m.Y', strtotime('+3 days')); ?>" class="form-control" name="data[Hostdowntime][to_date]">
									</div>
									<div class="col col-xs-5" style="padding-left: 0px;">
										<input type="text" id="HostdowntimeToTime" value="<?php echo date('h:m'); ?>" class="form-control" name="data[Hostdowntime][to_time]">
									</div>
								</div>
						...
						<div id="tab2" class="tab-pane fade">
							...
							<!-- from -->
							<div class="form-group">
								<label class="col col-md-2 control-label" for="HostgroupdowntimeFromDate"><?php echo __('From');?>:</label>
								<div class="col col-xs-5" style="padding-right: 0px;">
									<input type="text" id="HostgroupdowntimeFromDate" value="<?php echo date('d.m.Y'); ?>" class="form-control" name="data[Hostgroupdowntime][from_date]">
								</div>
								<div class="col col-xs-5" style="padding-left: 0px;">
									<input type="text" id="HostgroupdowntimeFromTime" value="<?php echo date('h:m'); ?>" class="form-control" name="data[Hostgroupdowntime][from_time]">
								</div>
							</div>

							<!-- to -->
							<div class="form-group">
								<label class="col col-md-2 control-label" for="HostgroupdowntimeToDate"><?php echo __('To');?>:</label>
								<div class="col col-xs-5" style="padding-right: 0px;">
									<input type="text" id="HostgroupdowntimeToDate" value="<?php echo date('d.m.Y', strtotime('+3 days')); ?>" class="form-control" name="data[Hostgroupdowntime][to_date]">
								</div>
								<div class="col col-xs-5" style="padding-left: 0px;">
									<input type="text" id="HostgroupdowntimeToTime" value="<?php echo date('h:m'); ?>" class="form-control" name="data[Hostgroupdowntime][to_time]">
								</div>
							</div>
							<?php echo $this->Form->formActions(); ?>
						</div>
