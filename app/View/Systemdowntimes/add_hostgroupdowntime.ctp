...
<div class="jarviswidget">
    <header>
        ...
        <h2 class="hidden-mobile hidden-tablet"><?php echo __('Create new host group downtime'); ?></h2>
        <div class="widget-toolbar">
            <a back-button fallback-state='SystemdowntimesHostgroup' class="btn btn-default btn-xs">
