...
<div class="row">
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		<div class="alert alert-info fade in">
			...
			<strong><?php echo __('Notice'); ?>:</strong> <?php echo __('Recurring downtimes with deleted objects will be deleted automatically by the cronjob'); ?>
		</div>
	</div>
</div>
				...
				<header>
					<div class="widget-toolbar" role="menu">
						...
						<ul class="dropdown-menu arrow-box-up-right color-select pull-right">
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="0"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Object type'); ?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="1"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Object name'); ?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="2"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('User'); ?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="3"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Comment'); ?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="4"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Wekkdays'); ?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="5"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Days of month'); ?></a></li>
						...
						?>
							<div class="btn-group">
								<button data-toggle="dropdown" class="btn dropdown-toggle btn-xs btn-default">
									<span id="listoptions_view" class="hidden-mobile" ><?php echo __('Recurring downtimes'); ?></span> <i class="fa fa-caret-down"></i>
								</button>
								<ul class="dropdown-menu pull-right">
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<div class="mobile_table">
							<table id="recurringdowntimes_list" class="table table-striped table-bordered smart-form" style="">
								<thead>
									<tr>
										<?php $order = $this->Paginator->param('order'); ?>
										<th class="no-sort"><?php echo __('Object type'); ?></th>
										<th class="no-sort"><?php echo __('Object name'); ?></th>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Systemdowntime.author'); echo $this->Paginator->sort('Systemdowntime.author', __('User')); ?></th>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Systemdowntime.comment'); echo $this->Paginator->sort('Systemdowntime.comment', __('Comment')); ?></th>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Systemdowntime.weekdays'); echo $this->Paginator->sort('Systemdowntime.weekdays', __('Weekdays')); ?></th>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Systemdowntime.day_of_month'); echo $this->Paginator->sort('Systemdowntime.day_of_month', __('Days of month')); ?></th>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Systemdowntime.from_time'); echo $this->Paginator->sort('Systemdowntime.from_time', __('Start time')); ?></th>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Systemdowntime.to_time'); echo $this->Paginator->sort('Systemdowntime.to_time', __('End time')); ?></th>
								...
								<tbody>
									...
									<?php foreach($all_systemdowntimes as $systemdowntime): ?>
										<tr>
											...
											<td><span class="text-muted">AUTO[<?php echo $systemdowntime['Systemdowntime']['id']; ?>]: </span><?php echo $systemdowntime['Systemdowntime']['comment']; ?></td>
											<td>
												<?php
