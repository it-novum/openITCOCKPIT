        ...
        <div class="widget-body">
            <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-12">
                    ...
                    {{ post.Systemdowntime.objecttype_id="<?php echo OBJECT_NODE; ?>";""}}
                    ...
                    <div class="form-group">
                        ...
                        echo $this->Form->fancyCheckbox('DowntimeIsInherit', [
                            'caption' => __('Inherit downtime'),
                            'wrapGridClass' => 'col col-xs-1 col-md-1 col-lg-1',
                            'captionGridClass' => 'col col-xs-1 col-md-1 col-lg-1',
                            'captionClass' => 'col col-xs-1 control-label text-left no-padding',
