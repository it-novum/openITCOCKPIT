		...
		<div class="widget-body">
				<div class="row">
					<div class="col-xs-12 col-md-9 col-lg-7">
							...
							<?php echo $this->Form->input('objecttype_id', ['type' => 'hidden', 'value' => OBJECT_HOST]);?>
							<?php echo $this->Form->input('downtimetype', ['type' => 'hidden', 'value' => 'host']);?>
							<?php echo $this->Form->input('object_id', ['options' => $hosts, 'multiple' => true, 'label' => __('Host'), 'class' => 'chosen col col-xs-12', 'selected' => $selected]); ?>
							<?php echo $this->Form->input('downtimetype_id', ['options' => $hostdowntimetyps, 'label' => __('Maintenance period for'), 'class' => 'chosen col col-xs-12']); ?>
