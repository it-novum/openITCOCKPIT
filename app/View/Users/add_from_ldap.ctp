        ...
        <div class="widget-body">
            <form ng-submit="submit();" class="form-horizontal">
                ...
                <div class="row">
                    ...
                    <div class="form-group" ng-class="{'has-error': errors.samaccountname}">
                        <label class="col col-md-2 control-label">
                            <?php echo __('SAM-Account-Name'); ?>
                        </label>
                        <div class="col col-xs-10">
                            <select
                                    id="UserSamaccountname"
                                    data-placeholder="<?php echo __('Please choose'); ?>"
                                    class="form-control"
                                    chosen="usersForSelect"
                                    callback="loadUsersByString"
                                    ng-options="user as user.samaccountname for user in usersForSelect"
                    ...
                    <div class="well formactions ">
                        <div class="pull-right">
                            <input class="btn btn-primary" type="submit"
                                   value="<?php echo __('Import new LDAP User'); ?>">
