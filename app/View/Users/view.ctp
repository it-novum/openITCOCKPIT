...
<div class="users view">
    ...
    <dl>
        ...
        <dt><?php echo __('Linkedin Id'); ?></dt>
        <dd>
            <?php echo h($user['User']['linkedin_id']); ?>
            &nbsp;
        </dd>
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Delete User'), ['action' => 'delete', $user['User']['id']], null, __('Are you sure you want to delete # %s?', $user['User']['id'])); ?> </li>
