					...
					<div class="row">
						<div class="col-md-2 no-padding">
							<div class="row pointer" id="collapseAll">
								<i class="fa fa-folder text-primary" title="<?php echo __('Collapse all');?>"></i> <?php echo __('Collapse all');?>
							</div>
							<div class="row pointer" id="expandAll">
								<i class="fa fa-folder-open text-primary" title="<?php echo __('Expand all');?>"></i> <?php echo __('Expand all');?>
							</div>
						</div>
							...
							<div class="row">
								...
								foreach($defaultActions as $action => $actionDetails):?>
									<div class="col-xs-1 col-md-1 col-lg-1 text-center">
										<i class="fa fa-<?php echo $actionDetails['icon'].' '.$actionDetails['class']; ?> " title="<?php echo ucfirst(__($action));?>"></i>
									</div>
								<?php
								endforeach;
								?>
							...
							<div class="row text-center">
								...
								foreach($defaultActions as $action => $actionDetails):?>
									<div class="no-padding col-xs-1 col-md-1 col-lg-1">
										<i class="fa fa-check-square-o pointer txt-color-blueDark" title="<?php echo __('Select all'); ?>" data-action="<?php echo $action; ?>" click-action="on"></i>
										<i class="fa fa-square-o pointer txt-color-blueDark" title="<?php echo __('Deselect all'); ?>" data-action="<?php echo $action; ?>" click-action="off"></i>
									</div>
								<?php
								endforeach;
								?>
