												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu pull-right">
														...
														<?php if($this->Acl->hasPermission('usedBy')): ?>
															<li>
																<a href="/<?php echo $this->params['controller']; ?>/usedBy/<?php echo $servicetemplate['Servicetemplate']['id']; ?>"><i class="fa fa-reply-all fa-flip-horizontal"></i> <?php echo __('Used by'); ?></a>
															</li>
														<?php endif; ?>
