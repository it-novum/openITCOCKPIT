                        ...
                        <?php if ($this->Acl->hasPermission('index')): ?>
                            <li class="">
                                <a href="<?php echo Router::url(['action' => 'index']); ?>"> <i
                                            ...
                                            class="hidden-mobile hidden-tablet"> <?php echo __('Commands'); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <li class="active">
                            <a href="<?php echo Router::url(['action' => 'hostchecks']); ?>"> <i
                                        class="fa fa-lg fa-code"></i> <span
                                        class="hidden-mobile hidden-tablet"> <?php echo __('Hostchecks'); ?></span> </a>
                        </li>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <?php if ($this->Acl->hasPermission('edit')): ?>
                                                    <a href="<?php echo Router::url(['action' => 'edit', '_controller' => 'commands', '_action' => 'hostchecks', $command['Command']['id']]); ?>"
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <?php if ($this->Acl->hasPermission('edit')): ?>
                                                        <li>
                                                            <a href="<?php echo Router::url(['action' => 'edit', '_controller' => 'commands', '_action' => 'hostchecks', $command['Command']['id']]); ?>"><i
