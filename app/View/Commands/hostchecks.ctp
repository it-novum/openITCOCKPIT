				...
				<header>
					<div class="widget-toolbar" role="menu">
						...
						if($this->Acl->hasPermission('add')):
							echo $this->Html->link(__('New'), Router::url(['action' => 'add', '_controller' => 'commands', '_action' => 'hostchecks']), array('class' => 'btn btn-xs btn-success', 'icon' => 'fa fa-plus'));
							echo " "; //Fix HTML;
						endif;
														...
														<td class="width-160">
															<div class="btn-group">
																<?php if($this->Acl->hasPermission('edit')): ?>
																	<a href="<?php echo Router::url(['action' => 'edit', '_controller' => 'commands', '_action' => 'hostchecks', $command['Command']['id']]); ?>" class="btn btn-default">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
																<?php else:?>
																...
																<ul class="dropdown-menu">
																	<?php if($this->Acl->hasPermission('edit')): ?>
																		<li>
																			<a href="<?php echo Router::url(['action' => 'edit', '_controller' => 'commands', '_action' => 'hostchecks', $command['Command']['id']]); ?>"><i class="fa fa-cog"></i> <?php echo __('Edit'); ?></a>
																		</li>
																	<?php endif;?>
