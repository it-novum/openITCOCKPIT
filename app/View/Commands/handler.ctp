				...
				<header>
					<div class="widget-toolbar" role="menu">
						...
						if($this->Acl->hasPermission('add')):
							echo $this->Html->link(__('New'), Router::url(['action' => 'add', '_controller' => 'commands', '_action' => 'handler']), array('class' => 'btn btn-xs btn-success', 'icon' => 'fa fa-plus'));
							echo " "; //Fix HTML
						endif;
														...
														<td>
															<div class="btn-group">
																<?php if($this->Acl->hasPermission('edit')): ?>
																	<a href="<?php echo Router::url(['action' => 'edit', '_controller' => 'commands', '_action' => 'handler', $command['Command']['id']]); ?>" class="btn btn-default">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
																<?php else:?>
																...
																<ul class="dropdown-menu pull-right">
																	<?php if($this->Acl->hasPermission('edit')): ?>
																		<li>
																			<a href="<?php echo Router::url(['action' => 'edit', '_controller' => 'commands', '_action' => 'handler', $command['Command']['id']]); ?>"><i class="fa fa-cog"></i> <?php echo __('Edit'); ?></a>
																		</li>
																	<?php endif;?>
