				...
				<header>
					<div class="widget-toolbar" role="menu">
						...
						<ul class="dropdown-menu arrow-box-up-right pull-right">
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="1"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Servicegroup name');?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="2"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Description');?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="3"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Services');?></a></li>
						</ul>
					...
					<h2 class="hidden-mobile"><?php echo __('Servicegroups'); ?></h2>
				</header>
				<div>
					<div class="widget-body no-padding">
						<?php echo $this->ListFilter->renderFilterbox($filters, array(), '<i class="fa fa-search"></i> '.__('search'), false, false); ?>
						<div class="mobile_table">
							<table id="servicegroup_list" class="table table-striped table-bordered smart-form" style="">
								<thead>
									<tr>
										<?php $order = $this->Paginator->param('order'); ?>
										<th class="no-sort" style="width: 15px;"><i class="fa fa-check-square-o fa-lg"></i></th>
										<th class="select_datatable no-sort"><?php echo $this->Utils->getDirection($order, 'Container.name'); echo $this->Paginator->sort('Container.name', __('Servicegroup name')); ?></th>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Servicegroup.description'); echo $this->Paginator->sort('Servicegroup.description', __('Description')); ?></th>
										...
										<tr>
											<td class="text-center">
												<?php if($this->Acl->hasPermission('edit') && $allowEdit):?>
													<input class="massChange" type="checkbox" name="servicegroup[<?php echo $servicegroup['Servicegroup']['id']; ?>]" servicegroupname="<?php echo h($servicegroup['Container']['name']); ?>" value="<?php echo $servicegroup['Servicegroup']['id']; ?>" />
												<?php endif;?>
											</td>
											...
											<td>
												<center>
													<?php if($this->Acl->hasPermission('edit') && $allowEdit): ?>
														<a href="/<?php echo $this->params['controller']; ?>/edit/<?php echo $servicegroup['Servicegroup']['id']; ?>" data-original-title="<?php echo __('edit'); ?>"><i id="list_edit" class="fa fa-gear fa-lg txt-color-teal"></i></a>
													<?php endif;?>
												</center>
											</td>
										</tr>
