				...
				<header>
					<div class="widget-toolbar" role="menu">
						...
						<ul class="dropdown-menu arrow-box-up-right color-select pull-right">
							...
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="4"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Host output'); ?></a></li>
						</ul>
						...
						<table id="hostchecks_list" class="table table-striped table-bordered smart-form" style="">
							<thead>
								<tr>
									...
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Hostcheck.state'); echo $this->Paginator->sort('Hostcheck.state', __('State')); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Hostcheck.start_time'); echo $this->Paginator->sort('Hostcheck.start_time', __('Date')); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Hostcheck.current_check_attempt'); echo $this->Paginator->sort('Hostcheck.current_check_attempt', __('Check attempt')); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Hostcheck.state_type'); echo $this->Paginator->sort('Hostcheck.state_type', __('State type')); ?></th>
									<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Hostcheck.output'); echo $this->Paginator->sort('Hostcheck.output', __('Host output')); ?></th>
								</tr>
							</thead>
							<tbody>
								...
								<?php foreach($all_hostchecks as $hostcheck): ?>
									<tr>
										...
										<td class="text-center"><?php echo h($hostcheck['Hostcheck']['current_check_attempt']);?>/<?php echo h($hostcheck['Hostcheck']['max_check_attempts']);?></td>
