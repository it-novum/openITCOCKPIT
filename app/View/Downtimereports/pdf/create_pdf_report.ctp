								...
								foreach(array_chunk($allHostsWithOutages, 10) as $hostsWithOutages):?>
									...
									foreach($hostsWithOutages as $hostWithOutages):?>
										<div class="jarviswidget jarviswidget-color-blueLight">
											<header role="heading">
												<h2>
													<strong class="txt-color-blueDark font-md">
														<i class="fa fa-desktop txt-color-blueDark"></i> <?php echo h($hostWithOutages['Host']['name']);
														?>
													</strong>
												</h2>
											</header>
													...
													<?php
														foreach($servicesWithOutages as $serviceWithOutages):?>
															...
															<div class="col-md-3 text-right padding-bottom-10">
																...
																?>
																<img src="<?php echo WWW_ROOT; ?>img/charts/<?php echo $overview_chart; ?>" width="100"/>
															</div>
															<?php
															for($i = 0; $i<=3; $i++):?>
								...
								foreach($hostsWithoutOutages as $hostWithoutOutages):?>
									<div class="jarviswidget jarviswidget-color-blueLight">
										<header role="heading">
											<h2>
												<strong class="txt-color-blueDark font-md">
													<i class="fa fa-desktop txt-color-blueDark"></i> <?php echo h($hostWithoutOutages['Host']['name']);
													?>
												</strong>
											</h2>
										</header>
