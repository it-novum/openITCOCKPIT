...
<section id="widget-grid" class="">
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false" >
				...
				<div>
					...
					<div class="widget-body no-padding">
						<?php
						echo $this->Form->create('Macro', array(
							...
							<table id="macrosTable" class="table table-striped table-bordered smart-form" style="">
								<thead>
									<tr>
										...
										<th><?php echo $this->Utils->getDirection($order, 'Macro.name'); echo $this->Paginator->sort('name', 'Name'); ?></th>
										<th><?php echo $this->Utils->getDirection($order, 'Macro.value'); echo $this->Paginator->sort('value', 'Value'); ?></th>
										<th colspan="2"><?php echo $this->Utils->getDirection($order, 'Macro.description'); echo $this->Paginator->sort('description', 'Description'); ?></th>
									</tr>
								</thead>
								<tbody>
									<?php
	...
	<div class="row">
		<span class="col col-md-10 col-xs-12 txt-color-redLight"><i class="fa fa-exclamation-circle"></i> <?php echo __('empty macros will be removed automatically'); ?></span>
		<span class="col col-md-10 col-xs-12 text-info"><i class="fa fa-info-circle"></i> <?php echo __('Nagios supports up to 256 $USERx$ macros ($USER1$ through $USER256$)'); ?></span>
	</div>
</section>