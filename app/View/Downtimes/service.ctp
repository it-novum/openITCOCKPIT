...
use itnovum\openITCOCKPIT\Core\Views\DowntimeIcon;
use itnovum\openITCOCKPIT\Core\Views\Host;
use itnovum\openITCOCKPIT\Core\Views\Service;
use itnovum\openITCOCKPIT\Core\Views\ListSettingsRenderer;

$ListSettingsRenderer = new ListSettingsRenderer($DowntimeListsettings);
$ListSettingsRenderer->setPaginator($this->Paginator);

$this->Paginator->options(['url' => Hash::merge($this->params['named'], $this->params['pass'], ['Listsettings' => $DowntimeListsettings])]); ?>
<div class="row">
                ...
                <header>
                    ...
                    <div class="widget-toolbar" role="menu">
                        ...
                        <ul class="dropdown-menu arrow-box-up-right pull-right">
                            ...
                            <li style="width: 100%;">
                                <a href="javascript:void(0)" class="select_datatable text-left" my-column="7">
                                    <input type="checkbox" class="pull-left"/>
                                    &nbsp;<?php echo __('End'); ?>
                                </a>
                            </li>
                            <li style="width: 100%;">
                                <a href="javascript:void(0)" class="select_datatable text-left" my-column="8">
                                    <input type="checkbox" class="pull-left"/>
                                    &nbsp;<?php echo __('Duration'); ?>
                                </a>
                            </li>
                            <li style="width: 100%;">
                                <a href="javascript:void(0)" class="select_datatable text-left" my-column="9">
                                    <input type="checkbox" class="pull-left"/>
                            ...
                            'formActionParams' => [
                                'url'   => Router::url(
                                    Hash::merge(
                                        $this->params['named'],
                                        $this->params['pass'],
                                        ['Listsettings' => $DowntimeListsettings]
                                    )),
                                'merge' => false
                            ]
                        ...
                        <div class="mobile_table">
                            <table id="servicedowntimes_list"
                                ...
                                <tr>
                                    ...
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'Service.name');
                                        echo $this->Paginator->sort('Service.name', __('Service')); ?>
                                    </th>
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'DowntimeService.author_name');
                                        echo $this->Paginator->sort('DowntimeService.author_name', __('User')); ?>
                                    </th>
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'DowntimeService.comment_data');
                                        echo $this->Paginator->sort('DowntimeService.comment_data', __('Comment')); ?>
                                    </th>
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'DowntimeService.entry_time');
                                        echo $this->Paginator->sort('DowntimeService.entry_time', __('Created')); ?>
                                    </th>
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'DowntimeService.scheduled_start_time');
                                        echo $this->Paginator->sort('DowntimeService.scheduled_start_time', __('Start')); ?>
                                    </th>
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'DowntimeService.scheduled_end_time');
                                        echo $this->Paginator->sort('DowntimeService.scheduled_end_time', __('End')); ?>
                                    </th>
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'DowntimeService.duration');
                                        echo $this->Paginator->sort('DowntimeService.duration', __('Duration')); ?>
                                    </th>
                                    <th class="no-sort">
                                        <?php echo $this->Utils->getDirection($order, 'DowntimeService.was_cancelled');
                                        echo $this->Paginator->sort('DowntimeService.was_cancelled', __('Was cancelled')); ?>
                                    </th>
                                ...
                                <?php foreach ($all_downtimes as $downtime):
                                    $Downtime = new Downtime($downtime['DowntimeService']);
                                    $DowntimeIcon = new DowntimeIcon($Downtime);
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo h($Downtime->getAuthorName()); ?></td>
                                        <td><?php echo h($Downtime->getCommentData()); ?></td>
                                        <td>
                                            <?php echo $this->Time->format(
                                                $Downtime->getEntryTime(),
                                        ...
                                        <td><?php echo $this->Utils->secondsInHuman($Downtime->getDuration()); ?></td>
                                        <td>
                                            <?php
                                        ...
                                        <td class="text-center">
                                            <?php if ($Downtime->isCancellable()): ?>
                                                <?php if ($this->Acl->hasPermission('delete', 'downtimes') && $downtime['canDelete']): ?>
                                                    <a class="btn btn-danger btn-xs delete_downtime"
                                                       href="javascript:void(0)"
                                                       internal-downtime-id="<?php echo h($Downtime->getInternalDowntimeId()); ?>"
                                                       downtimehistory-id="<?php echo h($Downtime->getDowntimehistoryId()); ?>"><i
