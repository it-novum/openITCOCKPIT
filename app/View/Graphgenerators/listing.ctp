...
<!--										<td>--><?php //echo $template['GraphgenTmpl']['relative_time']; ?><!--</td>-->
						...
						<div class="row">
							...
							<input type="hidden" id="delete_message_h2" value="<?php echo __('Do you really want to delete the selected graph configurations?'); ?>" />
							<input type="hidden" id="disable_message_h1" value="<?php echo __('Notice!'); ?>" />
<!--							<input type="hidden" id="disable_message_h2" value="--><?php //echo __('Do you really want disable the selected graph configurations?'); ?><!--" />-->
