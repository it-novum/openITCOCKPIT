							...
							<table id="host_list" class="table table-striped table-bordered smart-form" style="">
								...
								<tbody>
									...
									<?php foreach($all_systemsettings as $key => $values): ?>
										<tr>
											<td class="bg-color-lightGray text-primary" colspan="3"><strong><?php echo $key; ?></strong></td>
										<tr>
										<?php foreach($values as $value): ?>
											<tr>
												...
												<td>
													<div class="form-group">
														<div class="col col-xs-12">
															<input type="hidden" id="SystemsettingId" value="<?php echo h($value['id']); ?>" class="form-control" name="data[<?php echo $i; ?>][Systemsetting][id]">
															<?php
															switch($value['key']):
												...
												<td class="text-center"><a href="javascript:void(0);" data-original-title="<?php echo h($value['info']); ?>" data-placement="left" rel="tooltip" data-container="body"><i class="padding-top-5 fa fa-info-circle fa-2x"></i></a></td>
											</tr>
											<?php $i++; ?>
										<?php endforeach; ?>
									<?php endforeach; ?>
