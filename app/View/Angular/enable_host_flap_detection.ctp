<div id="angularEnableHostFalpDetectionModal" class="modal" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><h4>
                        ...
                        <?php echo __('Enable host flap detection'); ?>
                    </h4>
            </div>
            <div class="modal-body">
                ...
                <div class="row" ng-show="isEnableingHostFlapDetection">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" ng-click="doEnableHostFlapDetection()">
                    <?php echo __('Execute'); ?>
                </button>
