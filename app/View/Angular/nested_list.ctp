<li class="dd-item" data-id="{{ container.Container.id }}">
    ...
    <div class="dd-handle" parent-id="{{ container.Container.parent_id }}"
        ...
        <a class="txt-color-red padding-left-10 font-xs pointer"
           ...
           ng-click="confirmDelete(getObjectForDelete('hshud'))"
        >
    ...
    <ol class="dd-list" nested-list="" container="child" ng-repeat="child in container.children"
        ng-if="container.children"></ol>
