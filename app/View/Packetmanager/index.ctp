...
<?php if(isset($data) && version_compare($data->version, $openITCVersion) > 0): ?>
	<div class="alert alert-info alert-block">
		...
		<p class="text-align-right">
			<a class="btn btn-sm btn-primary" href="javascript:void(0);" data-toggle="modal" data-target="#updateProcess"><strong><?php echo __('How to update?'); ?></strong></a>
			<a class="btn btn-sm btn-default" href="javascript:void(0);" data-toggle="modal" data-target="#newReleaseChangelog" ><strong><?php echo __('What\'s new?'); ?></strong></a>
		</p>
	</div>
<?php endif; ?>
								...
								<div style="padding-top: 5px; padding-left: 15px;">
									<table>
										...
										<tr>
											...
											<td>&nbsp;<span class="tags"><?php echo h($module->Module->tags); ?></span></td>
										</tr>
									</table>
								</div>
							</div>
...
<div class="modal fade" id="newReleaseChangelog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal fade" id="package-manager-log" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
...
<div class="modal fade" id="updateProcess" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-rocket"></i> <?php echo __('Update instructions');?></h4>
			</div>
			<div class="modal-body">
