		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false" >
				<header>
					 ...
					 */ ?>
					<div class="widget-toolbar" role="menu">
						 <?php echo __('auto refresh'); ?>: <div class="pull-right padding-top-8 padding-left-10 padding-right-20" id="autoLoadChart"></div>
					</div>
							...
							<div class="row">
								<div class="padding-10">
									...
									<article class="col-xs-12 col-sm-12 col-md-4 col-lg-4 sortable-grid ui-sortable">
										<div class="jarviswidget jarviswidget-color-white" id="wid-id-1" data-widget-editbutton="false" >
											<header>
												<div class="jarviswidget-ctrls" role="menu"></div>
													...
													<table class="table table-bordered">
														...
														<tbody>
															<tr>
																...
																<td nagiostats="AVGACTSVCEXT" unit="s" warning="40" critical="60"></td>
															</tr>
															<tr>
																<td><?php echo __('Latency'); ?></td>
																<td nagiostats="MINACTSVCLAT" unit="s" warning="20" critical="50"></td>
																<td nagiostats="MAXACTSVCLAT" unit="s" warning="20" critical="50"></td>
																<td nagiostats="AVGACTSVCLAT" unit="s" warning="20" critical="50"></td>
															</tr>
															<tr>
																<td><?php echo __('State changes'); ?></td>
																<td nagiostats="MINACTSVCPSC" unit="%"</td>
																<td nagiostats="MAXACTSVCPSC" unit="%"</td>
																<td nagiostats="AVGACTSVCPSC" unit="%"</td>
															</tr>
														</tbody>
													</table>
												</div>
													...
													<table class="table table-bordered">
														...
														<tbody>
															<tr>
																...
																<td class="text-primary" nagiostats="NAGIOSVERSION" unit=""></td>
															</tr>
															<tr>
																<td><?php echo __('Core PID'); ?></td>
																<td class="text-primary" nagiostats="NAGIOSPID" unit=""></td>
															</tr>
															<tr>
															...
															<tr>
																...
																<td class="text-primary" nagiostats="NUMSERVICES" unit=""></td>
															</tr>
															<tr>
																<td><?php echo __('Program uptime'); ?></td>
																<td class="text-primary" nagiostats="PROGRUNTIME" unit=""></td>
															</tr>
														</tbody>
													</table>
												</div>
								...
								<div class="padding-10">
									...
									<article class="col-xs-12 col-sm-12 col-md-4 col-lg-4 sortable-grid ui-sortable">
										<div class="jarviswidget jarviswidget-color-white" id="wid-id-1" data-widget-editbutton="false" >
											...
											<div>
												<!-- widget content -->
												<div class="widget-body no-padding" style="min-height: 10px;"> <!-- removing min-height :( -->
													<table class="table table-bordered">
														<thead>
															<tr>
																<th><?php echo __('Key'); ?></th>
												...
												<div class="widget-body no-padding">
													<table class="table table-bordered">
														...
														<tbody>
															<tr>
																<td><?php echo __('Execution time'); ?></td>
																<td nagiostats="MINACTHSTEXT" unit="s" warning="40" critical="60"></td>
																<td nagiostats="MAXACTHSTEXT" unit="s" warning="40" critical="60"></td>
																<td nagiostats="AVGACTHSTEXT" unit="s" warning="40" critical="60"></td>
															</tr>
															<tr>
																<td><?php echo __('Latency'); ?></td>
																<td nagiostats="MINACTHSTLAT" unit="s" warning="20" critical="50"></td>
																<td nagiostats="MAXACTHSTLAT" unit="s" warning="20" critical="50"></td>
																<td nagiostats="AVGACTHSTLAT" unit="s" warning="20" critical="50"></td>
															</tr>
															<tr>
																<td><?php echo __('State changes'); ?></td>
