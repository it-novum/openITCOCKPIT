...
<div class="jarviswidget" id="wid-id-0">
	<header>
		...
		<h2><?php echo __('View: '); echo h($automap['Automap']['name']);?></h2>
...
<div class="modal fade" id="serviceDetailsModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-cogs"></i> <?php echo __('Service details');?></h4>
			</div>
					...
					<div id="modalContent">
						...
						<div class="col-xs-12 col-md-2">
							...
							<table>
								<tr>
									<td>
										<a href="javascript:void(0)" id="modalReschedule" data-original-title="<?php echo __('Reset check time'); ?>" data-placement="left" rel="tooltip" data-container="body" class="btn btn-default"><i class="fa fa-refresh"></i></a>
									</td>
								</tr>
								<tr>
									<td>
										<a href="javascript:void(0)" id="modalDowntime" data-toggle="modal" data-target="#nag_command_schedule_downtime" data-original-title="<?php echo __('Set planned maintenance times'); ?>" data-placement="left" rel="tooltip" data-container="body" class="btn btn-default"><i class="fa fa-clock-o"></i></a>
									</td>
								</tr>
								<tr>
									<td>
			...
			<div class="modal-footer">
				<a href="#" class="btn btn-primary" id="modalBrowserLink"><i class="fa fa-cog"></i> <?php echo __('Browser');?></a>
