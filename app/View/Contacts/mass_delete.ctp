						...
						<div class="col-xs-12 col-md-12 col-lg-6">
							<ul class="list-group">
								<li class="list-group-item group-item-danger">
									<i class="fa fa-trash-o"></i> <strong><?php echo __('The following %s will deleted', $this->Utils->pluralize($count, __('contact'), __('contacts'))); ?>:</strong>
								</li>
						...
						<?php if(!empty($contactsCanotDelete)): ?>
							<ul class="list-group">
								<li class="list-group-item active">
									<strong><i class="fa fa-info-circle"></i> <?php echo __('The following %s can\'t be deleted.', $this->Utils->pluralize($count, __('contact'), __('contacts'))); ?></strong> <i><?php echo __('(Used by other object)'); ?>:</i>
								</li>
