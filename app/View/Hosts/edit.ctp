	...
	<header>
		...
		<div class="widget-toolbar hidden-mobile hidden-tablet" role="menu">
			...
			<?php if($this->Acl->hasPermission('browser')): ?>
				<a href="/hosts/browser/<?php echo $host['Host']['id']; ?>" class="btn btn-default btn-xs"><i class="fa fa-desktop"></i> <?php echo __('Browser');?></a>
			<?php endif; ?>
						...
						<div class="tab-content">
							<div id="tab1" class="tab-pane fade active in">
								...
								<?php
									...
									elseif(!$hasRootPrivileges && $host['Host']['container_id'] != ROOT_CONTAINER):
										...
										<div class="form-group required">
											...
											<div class="col col-xs-8 required"><input type="text" value="/root" class="form-control" readonly></div>
										</div>
										<?php
									...
									echo $this->Form->input('hosttemplate_id', [
											'label' => '<a href="/hosttemplates/edit/' . $host['Host']['hosttemplate_id'] . '"><i class="fa fa-cog"></i> </a>' . __('Hosttemplate'),
								...
								<div class="form-group <?php echo (isset($validationErrors['priority']))?'has-error':'' ?>">
									...
									<div class="col col-xs-8 smart-form">
										<div class="rating pull-left">
											...
											?>
											<?php for($i = 5; $i > 0; $i--): ?>
												<input type="radio" <?php echo ($priority == $i)?'checked="checked"':'' ?> id="Hoststars-rating-<?php echo $i; ?>" value="<?php echo $i; ?>" name="data[Host][priority]">
								...
								<div class="form-group form-group-slider required <?php echo $this->CustomValidationErrors->errorClass('notification_interval'); ?>">
									...
									<div class="col col-xs-8 col-md-3">
										<input type="number" id="_HostNotificationinterval" human="#HostNotificationinterval_human" value="<?php echo $this->CustomValidationErrors->refill('notification_interval', ($host['Host']['notification_interval'] === null)?$host['Hosttemplate']['notification_interval']:$host['Host']['notification_interval']); ?>" slider-for="HostNotificationinterval" class="form-control slider-input" name="data[Host][notification_interval]">
										<span class="note" id="HostNotificationinterval_human"><?php echo $this->Utils->secondsInWords($this->CustomValidationErrors->refill('notification_interval', ($host['Host']['notification_interval'] === null)?$host['Hosttemplate']['notification_interval']:$host['Host']['notification_interval'])); ?></span>
								...
								<?php echo $this->Form->fancyCheckbox('active_checks_enabled', [
									...
									'wrapGridClass' => 'col col-xs-2',
									'captionGridClass' => 'col col-xs-3 no-padding',
								...
								if($ContactsInherited['inherit'] === true):
									...
									<span class="text-info"><i class="fa fa-info-circle"></i> <?php echo __('Contacts and Contactgroups are inherited in the following order:');?></span>
						...
						<?php endif; ?>
							...
							?>
								<?php echo $this->Form->input(
									...
									[
										'label' => __('Max. number of check attempts'),
							...
							<div class="form-group required <?php echo $this->CustomValidationErrors->errorClass('check_interval'); ?>">
								...
								<div class="col col-xs-5">
									<input type="text" id="HostCheckinterval" maxlength="255" value="<?php echo $this->CustomValidationErrors->refill('check_interval', ($host['Host']['check_interval'] === null)?$host['Hosttemplate']['check_interval']:$host['Host']['check_interval']); ?>" class="form-control slider slider-success" name="data[Host][check_interval]"
								...
								<div class="col col-xs-3">
									<input type="number" id="_HostCheckinterval" human="#HostCheckinterval_human" value="<?php echo $this->CustomValidationErrors->refill('check_interval', ($host['Host']['check_interval'] === null)?$host['Hosttemplate']['check_interval']:$host['Host']['check_interval']); ?>" slider-for="HostCheckinterval" class="form-control slider-input" name="data[Host][check_interval]">
									<span class="note" id="HostCheckinterval_human"><?php echo $this->Utils->secondsInWords($this->CustomValidationErrors->refill('check_interval', ($host['Host']['check_interval'] === null)?$host['Hosttemplate']['check_interval']:$host['Host']['check_interval'])); ?></span>
							...
							<div class="form-group required <?php echo $this->CustomValidationErrors->errorClass('retry_interval'); ?>">
								...
								<div class="col col-xs-3">
									<input type="number" id="_HostRetryinterval" human="#HostRetryinterval_human" value="<?php echo $this->CustomValidationErrors->refill('retry_interval', ($host['Host']['retry_interval'] === null)?$host['Hosttemplate']['retry_interval']:$host['Host']['retry_interval']); ?>" slider-for="HostRetryinterval" class="form-control slider-input" name="data[Host][retry_interval]">
									<span class="note" id="HostRetryinterval_human"><?php echo $this->Utils->secondsInWords($this->CustomValidationErrors->refill('retry_interval', ($host['Host']['retry_interval'] === null)?$host['Hosttemplate']['retry_interval']:$host['Host']['retry_interval'])); ?></span>
