            ...
            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false">
                <header>
                    <div class="widget-toolbar" role="menu">
                        <?php //echo $this->Html->link(__('Filter'), 'javascript:', array('class' => 'oitc-list-filter btn btn-xs btn-primary toggle', 'hide-on-render' => 'true', 'icon' => 'fa fa-filter')); ?>
                        <?php
                        ...
                        <div class="mobile_table">
                            <table id="host_list" class="table table-striped table-hover table-bordered smart-form" style="">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo $this->Utils->getDirection($order, 'Host.name');
                                        echo $this->Paginator->sort('Host.name', 'Hostname'); ?></th>
                                    <th><?php echo $this->Utils->getDirection($order, 'Hosttemplate.name');
                                        echo $this->Paginator->sort('Hosttemplate.name', 'Hosttemplate'); ?></th>
                                    <th><?php echo $this->Utils->getDirection($order, 'Host.address');
                                        echo $this->Paginator->sort('Host.address', __('Address')); ?></th>
                                    <th><?php echo $this->Utils->getDirection($order, 'Host.uuid');
                                        echo $this->Paginator->sort('Host.uuid', __('UUID')); ?></th>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    ...
                                                    <?php if ($this->Acl->hasPermission('enable') && $hasEditPermission): ?>
                                                        <li>
                                                            <a href="/<?php echo $this->params['controller']; ?>/enable/<?php echo $host['Host']['id']; ?>"><i
