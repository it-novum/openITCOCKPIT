			...
			<div class="widget-body no-padding">
				...
				<div class="tab-content padding-10">
					<div id="tab1" class="tab-pane fade active in">
						<?php
						echo $this->Form->create('SearchDefault', array(
					...
					<div id="tab2" class="tab-pane fade">
						<?php
						echo $this->Form->create('SearchKeywords', array(
							'class' => 'form-horizontal clear'
						));
						?>
						<div class="row">
					...
					<div id="tab3" class="tab-pane fade">
						<?php
						echo $this->Form->create('SearchAddress', array(
							'class' => 'form-horizontal clear'
						));
						?>
						<div class="row">
					...
					<div id="tab4" class="tab-pane fade">
						<?php
						echo $this->Form->create('SearchMacros', array(
							'class' => 'form-horizontal clear'
						));
						?>
						<div class="row">
							<div class="col-xs-12 col-md-9 col-lg-7">
								<strong><i class="fa fa-desktop"></i> <?php echo __('Search for host macros');?>:</strong>
								<br />
								<?php
						...
						<div class="row">
							<div class="col-xs-12 col-md-9 col-lg-7">
								<strong><i class="fa fa-cog"></i> <?php echo __('Search for service macros');?>:</strong>
								<br />
								<?php
					...
					<div id="tab5" class="tab-pane fade">
						<?php
						echo $this->Form->create('SearchUuid', array(
							'class' => 'form-horizontal clear'
						));
						?>
						<div class="row">
