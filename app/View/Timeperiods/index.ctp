				...
				<header>
					<div class="widget-toolbar" role="menu">
						...
						<ul class="dropdown-menu arrow-box-up-right pull-right">
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" class="select_datatable text-left" my-column="1"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Timeperiod name'); ?></a></li>
										...
										<tr>
											<td class="text-center" style="width: 15px;">
												<?php if($this->Acl->hasPermission('edit') && $allowEdit): ?>
													<input class="massChange" type="checkbox" name="timeperiod[<?php echo $timeperiod['Timeperiod']['id']; ?>]" timeperiodname="<?php echo h($timeperiod['Timeperiod']['name']); ?>" value="<?php echo $timeperiod['Timeperiod']['id']; ?>"/>
												<?php endif; ?>
											</td>
