				...
				<div>
					<div class="widget-body no-padding">
						...
						<div class="mobile_table">
							<table id="systemfailure_list" class="table table-striped table-bordered smart-form" style="">
								<thead>
									<tr>
										<?php $order = $this->Paginator->param('order'); ?>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Systemfailure.start_time'); echo $this->Paginator->sort('Systemfailure.start_time', __('Start')); ?></th>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Systemfailure.end_time'); echo $this->Paginator->sort('Systemfailure.end_time', __('End')); ?></th>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'User.full_name'); echo $this->Paginator->sort('User.full_name', __('Username')); ?></th>
										<th class="no-sort"><?php echo $this->Utils->getDirection($order, 'Systemfailure.comment'); echo $this->Paginator->sort('Systemfailure.comment', __('Comment')); ?></th>
