			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false" >
				...
				<header>
					<div class="widget-toolbar" role="menu">
						...
						<ul class="dropdown-menu arrow-box-up-right pull-right">
							...
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="3"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Date'); ?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="4"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('User'); ?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="5"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Notification type'); ?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="6"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Output'); ?></a></li>
						</ul>
						...
						<div class="widget-toolbar pull-left hidden-mobile" role="menu">
							...
							<div class="btn-group">
								<button data-toggle="dropdown" class="btn dropdown-toggle btn-xs btn-default">
									<span id="listoptions_view"><?php echo $selected; ?></span> <i class="fa fa-caret-down"></i>
								</button>
								...
								<input type="hidden" value="<?php if(isset($NotificationListsettings['view'])): echo $NotificationListsettings['view']; endif; ?>" id="listoptions_hidden_view" name="data[Listsettings][view]" />
							</div>
				...
				<div>
					...
					<div class="widget-body no-padding">
						<?php echo $this->ListFilter->renderFilterbox($filters, ['formActionParams' => ['url' => Router::url(Hash::merge($this->params['named'], $ListsettingsUrlParams)), 'merge' => false]], '<i class="fa fa-search"></i> '.__('Search'), false, false); ?>
