				...
				<header>
					<div class="widget-toolbar" role="menu">
						...
						<ul class="dropdown-menu arrow-box-up-right pull-right">
							...
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="4"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Contact'); ?></a></li>
							<li style="width: 100%;"><a href="javascript:void(0)" class="select_datatable text-left" my-column="5"><input type="checkbox" class="pull-left" /> &nbsp; <?php echo __('Notification method'); ?></a></li>
					...
					<div id="switch-1" class="widget-toolbar" role="menu">
						...
						echo $this->Form->create('notifications', [
							...
							'action' => 'serviceNotification/'.$service['Service']['id'] //reset the URL on submit
						]);
										...
										<td>
											<a href="/hosts/browser/<?php echo $notification['Service']['id']; ?>">
												...
												if($notification['Service']['name'] !== null && $notification['Service']['name'] != ''):
													...
													echo h($notification['Servicetemplate']['name']);
												endif;
												?>
											</a>
										</td>
