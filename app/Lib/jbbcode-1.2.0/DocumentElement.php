...
class DocumentElement extends ElementNode
{
     ...
     * Documents don't add any html. They only exist as a container for their children, so getAsHTML() simply iterates
     * through the document's children, returning their html.
