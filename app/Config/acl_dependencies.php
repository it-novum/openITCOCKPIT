    ...
    'acl_dependencies' => [
        ...
        'dependencies'   => [
            ...
            'Hosts'                 => [
                ...
                'add'        => ['loadContainers', 'loadCommands', 'loadElementsByContainerId', 'loadHosttemplate', 'runDnsLoopup'],
            ...
            'Users'                 => [
                ...
                'add'   => ['addFromLdap', 'loadLdapUserByString', 'loadStatus', 'loadDateformats'],
                'edit'  => ['resetPassword'],
            ],
            'Tenants'               => [
                'index'  => ['view'],
