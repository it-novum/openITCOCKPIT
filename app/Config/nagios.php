...
$config = [
	'nagios' => [
		...
		'nagios_status' => 'service nagios status',
		'ndo_status' => 'service ndo status',
		'npcd_status' => 'service npcd status',
		'mysql_status' => 'service mysql status',
		'phpnsta_status' => 'service phpNSTA status',
		'export' => [
			'minified' => true,
			...
			'check_fresh' => '/opt/openitc/nagios/libexec/check_fresh.php',
			'config' => 'config/',
			'suffix' => '.cfg',
