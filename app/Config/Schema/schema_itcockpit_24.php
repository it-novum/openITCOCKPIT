...
class AppSchema extends CakeSchema {
    ...
    public $hosts = [
        ...
        'satellite_id'                  => ['type' => 'integer', 'default' => 1],
    ...
    public $cronjobs = [
        'id'              => ['type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary'],
        'cronjobtype_id'  => ['type' => 'integer', 'default' => null],
    ...
    public $autoreports = [
        'id'                       => ['type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary'],
        'reportname'               => ['type' => 'string', 'null' => false, 'default' => null, 'length' => 200, 'collate' => 'utf8_swedish_ci', 'charset' => 'utf8'],
        'report_description'       => ['type' => 'string', 'null' => false, 'default' => null, 'collate' => 'utf8_swedish_ci', 'charset' => 'utf8'],
        'tenant_id'                => ['type' => 'integer', 'null' => false, 'default' => null, 'key' => 'index'],
        ...
        'min_availability'         => ['type' => 'float', 'null' => true, 'default' => null, 'length' => '6,3'],
    ...
    public $hosts_to_autoreports = [
        'id'                => ['type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary'],
        'report_id'         => ['type' => 'integer', 'null' => false, 'default' => null, 'key' => 'index'],
        'host_id'           => ['type' => 'integer', 'null' => false, 'default' => null, 'key' => 'index'],
        'show_percentage'   => ['type' => 'boolean', 'null' => false, 'default' => null],
        'show_time'         => ['type' => 'boolean', 'null' => false, 'default' => null],
        'show_alias'        => ['type' => 'boolean', 'null' => false, 'default' => null],
        'outage_duration'   => ['type' => 'integer', 'null' => true, 'default' => null],
        'show_all_failures' => ['type' => 'integer', 'null' => false, 'default' => '0', 'length' => 4],
        'indexes'           => [
            'PRIMARY'        => ['column' => 'id', 'unique' => 1],
            'id_report_host' => ['column' => ['report_id', 'host_id'], 'unique' => 1],
    ...
    public $services_to_autoreports = [
        ...
        'show_percentage'   => ['type' => 'boolean', 'null' => false, 'default' => null],
        'show_time'         => ['type' => 'boolean', 'null' => false, 'default' => null],
        'show_graph'        => ['type' => 'boolean', 'null' => false, 'default' => null],
        'outage_duration'   => ['type' => 'integer', 'null' => true, 'default' => null],
        'show_all_failures' => ['type' => 'integer', 'null' => false, 'default' => '0', 'length' => 4],
        'indexes'           => [
            'PRIMARY'           => ['column' => 'id', 'unique' => 1],
            'id_report_service' => ['column' => ['report_id', 'service_id'], 'unique' => 1],
    ...
    public $users_to_autoreports = [
        'id'              => ['type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary'],
        'report_id'       => ['type' => 'integer', 'null' => false, 'default' => null],
