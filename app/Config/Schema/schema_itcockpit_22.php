...
class AppSchema extends CakeSchema
{
    ...
    public $changelogs = [
        ...
        'service_id'      => ['type' => 'integer', 'default' => null],
    ...
    public $hostdependencies = [
        'id'                  => ['type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary'],
        'inherit_parent'      => ['type' => 'integer', 'null' => false, 'default' => '0', 'length' => 1],
        'timeperiod_id'       => ['type' => 'integer', 'null' => true, 'default' => null],
        'fail_on_up'          => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'fail_on_down'        => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'fail_on_unreachable' => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'fail_on_down'        => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'none'                => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'created'             => ['type' => 'datetime', 'null' => false, 'default' => null],
        'modified'            => ['type' => 'datetime', 'null' => false, 'default' => null],
        'indexes'             => [
            'PRIMARY' => ['column' => 'id', 'unique' => 1],
    ...
    public $servicedependencies = [
        ...
        'inherit_parent'   => ['type' => 'integer', 'null' => false, 'default' => '0', 'length' => 1],
        'timeperiod_id'    => ['type' => 'integer', 'null' => true, 'default' => null],
        'fail_on_ok'       => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'fail_on_warning'  => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'fail_on_unknown'  => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'fail_on_critical' => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'fail_on_pending'  => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'none'             => ['type' => 'integer', 'null' => false, 'default' => null, 'length' => 1],
        'created'          => ['type' => 'datetime', 'null' => false, 'default' => null],
        'modified'         => ['type' => 'datetime', 'null' => false, 'default' => null],
        'indexes'          => [
