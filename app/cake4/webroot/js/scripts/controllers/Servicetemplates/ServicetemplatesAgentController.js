angular.module('openITCOCKPIT')
    .controller('ServicetemplatesAgentController', function($scope, $http, $rootScope, SortService, MassChangeService, QueryStringService, $state){
        ...
        $scope.load = function(){
            ...
            $http.get("/servicetemplates/agent.json", {
                params: params
