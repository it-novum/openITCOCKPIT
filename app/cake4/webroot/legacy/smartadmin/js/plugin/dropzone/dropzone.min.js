            ...
            Dropzone = (function(_super) {
                ...
                Dropzone.prototype.init = function() {
                    ...
                    if (this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message")) {
                        this.element.appendChild(Dropzone.createElement('<div class="dz-default dz-message"><span class="font-lg"><i class="fa fa-caret-right text-danger"> </i>' + this.options.dictDefaultMessage + "</span></div>"))
                    }
