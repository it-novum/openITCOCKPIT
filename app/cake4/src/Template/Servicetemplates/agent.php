            ...
            <div class="jarviswidget jarviswidget-color-blueDark">
                <header>
                    <div class="widget-toolbar" role="menu">
                        ...
                        <?php if ($this->Acl->hasPermission('add', 'servicetemplates')): ?>
                            <a class="btn btn-xs btn-success"
                               ui-sref="ServicetemplatesAdd({servicetemplateTypeId: <?php echo OITC_AGENT_SERVICE; ?>})">
                    ...
                    <h2 class="hidden-mobile">
                        <?php echo __('openITCOCKPIT Agent service templates overview'); ?>
                    </h2>
                                    ...
                                    <td class="width-50">
                                        <div class="btn-group">
                                            <?php if ($this->Acl->hasPermission('edit', 'servicetemplates')): ?>
                                                <a ui-sref="ServicetemplatesEdit({id: servicetemplate.Servicetemplate.id, servicetemplateTypeId: <?php echo OITC_AGENT_SERVICE; ?>})"
