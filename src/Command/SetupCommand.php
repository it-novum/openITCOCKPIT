...
class SetupCommand extends Command {
    ...
    public function execute(Arguments $args, ConsoleIo $io) {
        ...
        $this->io->hr();
        $this->io->out("<blue>                        ___ _____ ____ ___   ____ _  ______ ___ _____</blue>");
        $this->io->out("<blue>  ___  _ __   ___ _ __ |_ _|_   _/ ___/ _ \ / ___| |/ /  _ \_ _|_   _|</blue>");
        $this->io->out("<blue> / _ \| '_ \ / _ \ '_ \ | |  | || |  | | | | |   | ' /| |_) | |  | |</blue>");
        $this->io->out("<blue>| (_) | |_) |  __/ | | || |  | || |__| |_| | |___| . \|  __/| |  | |</blue>");
        $this->io->out("<blue> \___/| .__/ \___|_| |_|___| |_| \____\___/ \____|_|\_\_|  |___| |_|</blue>");
        $this->io->out("<blue>      |_|</blue>");
        $this->io->hr();
