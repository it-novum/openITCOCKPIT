...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <?php echo __('Create new Statuspage'); ?>
                </h2>
            ...
            {objectName : '<?php echo __('Statuspage'); ?>' , message: '<?php echo __('created successfully'); ?>'}">
                        ...
                        <div class="form-group" ng-class="{'has-error': errors.show_comments}">
                            ...
                            <div class="col col-xs-12 col-md-offset-2 help-block">
                                <?php echo __('If enabled internal statuspages will show downtime and acknowledgement comments for each element. Public visible statuspages will always show anonymized comments'); ?>
                            </div>
                        </div>
