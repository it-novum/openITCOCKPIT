                    ...
                    <?php endif; ?>
                        ...
                        <div class="pt-1">
                            <table class="table">
                                ...
                                <tr>
                                    <td><div><h5> <?php echo __('Start'); ?>: <?= h($item['downtimeData']['scheduledStartTime']) ?></h5></div></td>
                                    <td><div><h5><?php echo __('End'); ?>: <?= h($item['downtimeData']['scheduledEndTime']) ?></h5></div></td>
                                    <td><div><h5><?php echo __('Comment'); ?>:
