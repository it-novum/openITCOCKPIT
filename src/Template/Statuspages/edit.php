                ...
                <div class="panel-content">
                    <div class="card margin-bottom-10">
                        <div class="card-header">
                            ...
                            <button class="badge badge-primary" ng-click="triggerBaseEdit()">
                                <?php echo __('Edit'); ?>
                            </button>
                            </div>
                        </div>
                        <div class="card-body" ng-show="showBase">
                            <form ng-submit="submitBase();" class="form-horizontal"
                                  ng-init="successMessage=
                                    {objectName : '<?php echo __('Statuspage'); ?>' , message: '<?php echo __('updated successfully'); ?>'}">
                    ...
                    <div class="card margin-bottom-10">
                        ...
                        <div class="card-body">
                            <div class="margin-top-10" ng-show="post.Statuspage.statuspage_items.length == 0">
                                <div class="text-center text-danger italic">
                                    <?php echo __('No item entries'); ?>
                                </div>
                            </div>
                            <div>
                                <button class="badge badge-primary" ng-click="triggerBaseEdit()">
