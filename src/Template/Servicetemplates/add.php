                                ...
                                <div class="form-group required"
                                    ...
                                    <label class="control-label">
                                        <?php if ($this->Acl->hasPermission('edit', 'timeperiods')): ?>
                                            ...
                                            <span ng-if="post.Servicetemplate.check_period_id == 0"><?php echo __('Check period'); ?></span>
                                        <?php else: ?>
                                            <?= __('Check period'); ?>
                                        <?php endif; ?>
                                    </label>
                                ...
                                <div class="form-group required"
                                    ...
                                    <label class="control-label">
                                        <?php if ($this->Acl->hasPermission('edit', 'commands')): ?>
                                            ...
                                            <span ng-if="post.Servicetemplate.command_id == 0"><?php echo __('Check command'); ?></span>
                                        <?php else: ?>
                                            <?= __('Check command'); ?>
                                        <?php endif; ?>
                                    </label>
                                ...
                                <div class="form-group required"
                                    ...
                                    <label class="control-label" for="NotificationPeriod">
                                        <?php if ($this->Acl->hasPermission('edit', 'timeperiods')): ?>
                                            ...
                                            <span ng-if="post.Servicetemplate.notify_period_id == 0"><?php echo __('Notification period'); ?></span>
                                        <?php else: ?>
                                            <?php echo __('Notification period'); ?>
                                        <?php endif; ?>
                                    </label>
