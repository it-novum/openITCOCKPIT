<div id="angularDisableServiceNotificationsModal" class="modal z-index-2500" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="far fa-envelope"></i>
                    <?php echo __('Disable service notifications'); ?>
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="row" ng-show="isDisableingServiceNotifications">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" ng-click="doDisableServiceNotifications()">
                    <?php echo __('Execute'); ?>
                </button>
