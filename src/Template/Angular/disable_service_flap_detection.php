<div id="angularDisableServiceFlapDetectionModal" class="modal z-index-2500" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 text-center padding-top-10">
                        <div class="card card-body">
                            <span class="hintmark">
                                <?php echo __('Yes, I would like to temporarily <strong>disable</strong> flap detection.'); ?>
                            </span>
                ...
                <div class="row" ng-show="isDisableingServiceFlapDetection">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" ng-click="doDisableServiceFlapDetection()">
                    <?php echo __('Execute'); ?>
                </button>
