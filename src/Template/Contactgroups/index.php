                                ...
                                <td class="width-50">
                                    <div class="btn-group btn-group-xs" role="group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <?php endif; ?>
                                            <?php if ($this->Acl->hasPermission('nagiosConfiguration', 'contactgroups')): ?>
                                                <a href="javascript:void(0);"
                                                   class="dropdown-item"
                                                   ng-click="showNagiosConfiguration(contactgroup.Contactgroup.id)">
...
<!-- Show contact group config modal -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="fa fa-file-code"></i>
                    <?php echo __('Contact group Configuration'); ?>
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        type="text"
                        readonly
                        ng-model="contactgroupConfig.file">
                </div>

                <div class="form-group" ng-repeat="(label, value) in contactgroupConfig.content">
                    <label class="control-label">
                        {{ label }}
                    </label>
                    <input
