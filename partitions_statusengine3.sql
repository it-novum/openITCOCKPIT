...
(
    ...
    `logentry_data` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(
    ...
    `output`                varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
    `long_output`           varchar(8192) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(
    ...
    `perfdata`              varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
    `command`               varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
    `current_check_attempt` smallint(5) unsigned                  DEFAULT '0',
    `max_check_attempts`    smallint(5) unsigned                  DEFAULT '0',
    `long_output`           varchar(8192) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(
    ...
    `contact_name` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
    `command_name` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
    `command_args` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
    `state`        smallint(5) unsigned                  DEFAULT '0',
    `start_time`   bigint(20)          NOT NULL,
    `end_time`     bigint(20)          NOT NULL,
    `reason_type`  smallint(5) unsigned                  DEFAULT '0',
    `output`       varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
    `ack_author`   varchar(255) COLLATE utf8_unicode_ci  DEFAULT NULL,
    `ack_data`     varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
